$(function () {
    _zw.formEx = {
        ...
        "make": function (f) {
            if (_zw.V.biz == "사전승인" && _zw.V.act == "__r") _zw.body.main(f, ["POSSIBLE", "CUSTOMEROK", "SENDATA"]);
            else if (_zw.V.biz == "자료송부" && _zw.V.act == "__r") _zw.body.main(f, ["MANAGECHECK", "CHECK1", "CHECK2", "CHECK3", "CHECK4", "CHECK5", "CHECK6"]);
            else if (_zw.V.biz == "샘플제작" && _zw.V.act == "__r") _zw.body.main(f, ["MAKECHECK"]);
            else if (_zw.V.biz == "진행요청" && _zw.V.act == "__r") _zw.body.main(f, ["REQUESTGO"]);
            else if (_zw.V.biz == "샘플검토" && _zw.V.act == "__r") _zw.body.main(f, ["ENVIORCHECK"]);
            else if (_zw.V.biz == "결과통보" && _zw.V.act == "__r") _zw.body.main(f, ["REQUESTALLOW"]);
            else if (_zw.V.biz == "승인요청" && _zw.V.act == "__r") _zw.body.main(f, ["CUSTOMERCHECK", "DEVCLASSETC","CUSTOMERDETAIL"]);
            else if (_zw.V.biz == "승인완료" && _zw.V.act == "__r") _zw.body.main(f, ["MASTERDATE","PCNDATE"]);
        },
        "checkEvent": function (ckb, el, fld) {
            if (fld == 'CUSTOMERCHECK') {
                var t = $('#__mainfield[name="DEVCLASSETC"]')
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.substr(0, 2) == 'OK') {
                            ...
                            var row = vPos[1] == 'items' ? el.parent().parent() : null;
