    ...
    _zw.formEx = {
        ...
        "calc": function (el) {
            ...
            if (el.name == 'EXPENSE') {
                ...
                p.find(':text[name="EXPENSE"]').each(function (idx, e) { s += numeral(e.value).value(); })
        ...
        "date": function (el) {
            var from, to;
            if (el.name == 'FROMDAY' || el.name == 'TODAY') {
                from = $('#__mainfield[name="FROMDAY"]'); to = $('#__mainfield[name="TODAY"]');
            } else if (el.name == 'FROMDATE' || el.name == 'TODATE') {
                row = $(el).parent().parent();
                from = row.find('input[name="FROMDATE"]'); to = row.find('input[name="TODATE"]');
            }
