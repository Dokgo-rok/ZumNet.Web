        ...
        "orgSelect": function (p, x) {
            p.find('.zf-org .zf-org-select input:checkbox[data-for]').each(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/EA/Common",
                    data: '{M:"getreportsearch",body:"S", k1:"",k2:"' + _zw.V.ft + '",k3:"",v1:"' + info["id"] + '",v2:"",v3:""}',
                    success: function (res) {
                        if (res.substr(0, 2) == 'OK') {
                            ...
                            $('#__mainfield[name="INDATE"]').parent().find('span').html(_zw.ut.dateLocale(person.INDATE, "en") + " ~ " + _zw.ut.dateLocale($('#__mainfield[name="REQUESTDATE"]').val(), "en") + "<br />(" + _zw.ut.dateLocale(person.INDATE, "ko") + " ~ " + _zw.ut.dateLocale($('#__mainfield[name = "REQUESTDATE"]').val(), "ko") + ")");
                        }
