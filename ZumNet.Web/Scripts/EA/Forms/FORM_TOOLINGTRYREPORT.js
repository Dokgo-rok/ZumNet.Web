    ...
    _zw.formEx = {
				...
				$.ajax({
					...
					success: function (res) {
						...
						if (res.substr(0, 2) == 'OK') {
							...
							var row = x == 'STOREPLACE' || x == 'REPAIRPLACE' ? el.parent().parent() : null;
		...
		"insertToolingData": function (pos, res) {
			if (res.length > 0) {
				...
				for (var i = 0; i < v1.length; i++) {
					if (v1[i].length > 0) {
						...
						if (i == 0) {//console.log(v2)
							el = $('#__mainfield[name="TOOLINGNUMBER"]'); if (el && el.length > 0) el.val(v2[0]);
							el = $('#__mainfield[name="STOREPLACE"]'); if (el && el.length > 0) el.val(v2[1]);
							el = $('#__mainfield[name="STOREPLACEID"]'); if (el && el.length > 0) el.val(v2[2]);
							el = $('#__mainfield[name="STOREPLACESITEID"]'); if (el && el.length > 0) el.val(v2[3]);
							el = $('#__mainfield[name="OWNER"]'); if (el && el.length > 0) el.val(v2[4]);
							el = $('#__mainfield[name="OWNERID"]'); if (el && el.length > 0) el.val(v2[5]);
							el = $('#__mainfield[name="OWNERSITEID"]'); if (el && el.length > 0) el.val(v2[6]);
							el = $('#__mainfield[name="SETUPPLACE"]'); if (el && el.length > 0) el.val(v2[7]);
							el = $('#__mainfield[name="CAVITY"]'); if (el && el.length > 0) el.val(v2[8]);

							el = $('#__mainfield[name="CAVITYA"]'); if (el && el.length > 0) el.val(v2[22]);
							el = $('#__mainfield[name="USABLECAVITYA"]'); if (el && el.length > 0) el.val(v2[23]);
							el = $('#__mainfield[name="USABLECAVITY"]'); if (el && el.length > 0) el.val(v2[24]);

							el = $('#__mainfield[name="SHOT"]'); if (el && el.length > 0) el.val(v2[9]);
							el = $('#__mainfield[name="EXPIREDSHOT"]'); if (el && el.length > 0) el.val(v2[10]);
							el = $('#__mainfield[name="COMPLETEDATE"]'); if (el && el.length > 0) el.val(v2[11]);

							el = $('#__mainfield[name="PREPLACE"]'); if (el && el.length > 0) el.val(v2[19]);
							el = $('#__mainfield[name="FROMDATE"]'); if (el && el.length > 0) el.val(v2[20]);
							el = $('#__mainfield[name="TODATE"]'); if (el && el.length > 0) el.val(v2[21]);

							el = $('#__mainfield[name="CUSTOMER"]'); if (el && el.length > 0) el.val(v2[12]);
							el = $('#__mainfield[name="BUYERID"]'); if (el && el.length > 0) el.val(v2[13]);
							el = $('#__mainfield[name="BUYERSITEID"]'); if (el && el.length > 0) el.val(v2[14]);
							el = $('#__mainfield[name="MAKESUPPLIER"]'); if (el && el.length > 0) el.val(v2[15]);
							el = $('#__mainfield[name="MAKESUPPLIERID"]'); if (el && el.length > 0) el.val(v2[16]);
							el = $('#__mainfield[name="MAKESUPPLIERSITEID"]'); if (el && el.length > 0) el.val(v2[17]);

							el = $('#__mainfield[name="CMNTYPE"]'); if (el && el.length > 0) el.val(v2[18]);
						} else {
				...
				var el2 = $('#__mainfield[name="MODELOID"]'); if (el2 && el2.length > 0) el2.val('');
				var el3 = $('#__mainfield[name="MODELNO"]'); if (el3 && el3.length > 0) el3.val('');
				var el4 = $('#__mainfield[name="MODELNM"]'); if (el4 && el4.length > 0) el4.val('');
				if (vModel != '') {
					vModel = vModel.split(c2);
					if (el2) el2.val(vModel[0]); if (el3) el3.val(vModel[1]); if (el4) el4.val(vModel[2]);
				}

				el = $('#__mainfield[name="PARTNO1"]');
				if (el && el.length > 0) {
