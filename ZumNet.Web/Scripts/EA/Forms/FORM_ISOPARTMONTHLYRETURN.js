$(function () {
    _zw.formEx = {
		...
		"date": function (el) {
			var from, to;
			if (el.name == 'FROMDATEA' || el.name == 'TODATEA') {
				from = $('#__mainfield[name="FROMDATEA"]'); to = $('#__mainfield[name="TODATEA"]');
			} else if (el.name == 'FROMDATEB' || el.name == 'TODATEB') {
				from = $('#__mainfield[name="FROMDATEB"]'); to = $('#__mainfield[name="TODATEB"]');
			}
