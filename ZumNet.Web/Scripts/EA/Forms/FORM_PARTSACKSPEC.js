                        ...
                        if (res.substr(0, 2) == 'OK') {
                            ...
                            p.find('.zf-modal .z-lnk-navy[data-val]').click(function () {
                                ...
                                for (var i = 0; i < param.length; i++) {
                                    $('#__mainfield[name="' + param[i] + '"]').val(v[i]);
                                    //alert(param[i] + " : " + v[i])
                                    if (param[i] == 'ITEMNO') $('#__mainfield[name="PARTNUM"]').val(v[i]);
                                    else if (param[i] == 'ITEMNAME') $('#__mainfield[name="PARTNAME"]').val(v[i]);
                                    else if (param[i] == 'MODELNAME') $('#__mainfield[name="MODELNAME2"]').val(v[i]);
                                }
