                  ...
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          <td class="f-lbl-sub" colspan="9">TOTAL</td>
                        </xsl:otherwise>
                      </xsl:choose>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="ROWNUM" class="txtNumberic" maxlength="5" value="{ROWNUM}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="MODELNAME" class="txtText" maxlength="100" value="{MODELNAME}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="ITEMNAME" class="txtText" maxlength="200" value="{ITEMNAME}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="PRICEA" class="txtText" maxlength="20" value="{PRICEA}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="PRICEB" class="txtText" maxlength="20" value="{PRICEB}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="PRICEC" class="txtText" maxlength="20" value="{PRICEC}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="PRICED" class="txtText" maxlength="20" value="{PRICED}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="COMPANY" class="txtText" maxlength="200" value="{COMPANY}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="TTLLT" class="txtCurrency" maxlength="20" value="{TTLLT}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="PRELT" class="txtCurrency" maxlength="20" value="{PRELT}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="PROCESSLT" class="txtCurrency" maxlength="20" value="{PROCESSLT}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
            <input type="text" name="POSTLT" class="txtCurrency" maxlength="20" value="{POSTLT}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
