		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .fm-editor {height:650px;vertical-align:top;border:windowtext 1.5pt solid;}
          ...
          .m .ft td {height:24px;word-break:break-all;border-right:windowtext 1pt solid;border-bottom:windowtext 1pt solid;padding-left:2px;padding-right:2px;padding-top:1px}
          ...
          .m .ft-sub td {height:24px;word-break:break-all;border-right:windowtext 1pt solid;border-top:windowtext 1pt solid;padding-left:2px;padding-right:2px;padding-top:1px}
						...
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
								...
								<td colspan="3" style="border-right:0">
									<xsl:choose>
										...
										<xsl:otherwise>
											...
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/PURPOSE))" />
										</xsl:otherwise>
									</xsl:choose>									
								</td>
							</tr>
								...
								<td>
									<xsl:choose>
										...
										<xsl:otherwise>
											...
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/TRAFFIC))" />
										</xsl:otherwise>
									</xsl:choose>									
								</td>
								<td class="f-lbl">숙박</td>
								<td style="border-right:0;">
									<xsl:choose>
										<xsl:when test="$mode='new'">
											...
											<xsl:otherwise>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/STAYHOUSE))" />
												<!--<xsl:attribute name="class">txtRead</xsl:attribute>
												<xsl:attribute name="readonly">readonly</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/STAYHOUSE" />
							...
							<tr>
								...
								<td colspan="3" style="border-bottom:0;border-right:0">
									<input type="text" name="CONTACT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">50</xsl:attribute>
