                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:40px">
                        ...
                        <td class="f-lbl-sub" style="border-top:0">UOM</td>
                        ...
                        <td class="f-lbl-sub" style="border-top:0">LT</td>
                        <td class="f-lbl-sub" style="border-top:0">업체명</td>
                        <td class="f-lbl-sub" style="border-top:0">업체<br />코드</td>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'  or $actrole='__r' or $actrole='_reviewer'">
            <input type="text" name="MODELNAME" style="width:84%">
      ...
      <td>
		...
		<td>
			<xsl:choose>
				<xsl:when test="$mode='new' or $mode='edit'  or $actrole='__r' or $actrole='_reviewer'">
					<input type="text" name="UOM" style="width:64%" class="txtText_u" readonly="readonly" value="{UOM}" />
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'  or $actrole='__r' or $actrole='_reviewer'">
            <input type="text" name="COMPANY" style="width:86%">
              <xsl:attribute name="class">txtText_u</xsl:attribute>
              <xsl:attribute name="readonly">readonly</xsl:attribute>
              <xsl:attribute name="value">
