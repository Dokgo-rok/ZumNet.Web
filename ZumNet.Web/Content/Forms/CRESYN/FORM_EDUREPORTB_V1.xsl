        ...
        <div class="m">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="width:308px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='normal' and @partid!='' and @step!='0'], '__si_Normal', '4', '작성부서', 'N')"/>
                </td>
                <td style="width:72px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignEdgePart($root, //processinfo/signline/lines/line[@bizrole='last' and @partid!='' and @step!='0'], '__si_Last', '1', '')"/>
                </td>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td colspan="11" style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
              ...
              <tr>
                ...
                <td colspan="2" class="f-lbl1" style="border-bottom:0">교육기관</td>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl">실시</td>
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DELIVERYB">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/DELIVERYB" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DELIVERYB))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
              <tr>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DELIVERYC">
                        <xsl:attribute name="class">txtText</xsl:attribute>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>
                  <span class="f-option">
                    <input type="checkbox" id="ckb11" name="ckbSATISFACTIONA" value="만족">
                      <xsl:if test="$mode='new' or $mode='edit'">
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb12" name="ckbSATISFACTIONA" value="보통">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbSATISFACTIONA', this, 'SATISFACTIONA')</xsl:attribute>
                      </xsl:if>
                    ...
                    <label for="ckb12">보통</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb13" name="ckbSATISFACTIONA" value="미흡">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbSATISFACTIONA', this, 'SATISFACTIONA')</xsl:attribute>
                      </xsl:if>
                ...
                <td style="width:38%;border-right:0">
                  <span class="f-option">
                    <input type="checkbox" id="ckb21" name="ckbSATISFACTIONB" value="만족">
                      <xsl:if test="$mode='new' or $mode='edit'">
                    ...
                    <label for="ckb21">만족</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb22" name="ckbSATISFACTIONB" value="보통">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbSATISFACTIONB', this, 'SATISFACTIONB')</xsl:attribute>
                      </xsl:if>
                    ...
                    <label for="ckb22">보통</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb23" name="ckbSATISFACTIONB" value="미흡">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbSATISFACTIONB', this, 'SATISFACTIONB')</xsl:attribute>
                      </xsl:if>
              ...
              <tr>
                ...
                <td style="border-bottom:0">
                  <span class="f-option">
                    <input type="checkbox" id="ckb31" name="ckbSATISFACTIONC" value="만족">
                      <xsl:if test="$mode='new' or $mode='edit'">
                    ...
                    <label for="ckb31">만족</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb32" name="ckbSATISFACTIONC" value="보통">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbSATISFACTIONC', this, 'SATISFACTIONC')</xsl:attribute>
                      </xsl:if>
                    ...
                    <label for="ckb32">보통</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb33" name="ckbSATISFACTIONC" value="미흡">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbSATISFACTIONC', this, 'SATISFACTIONC')</xsl:attribute>
                      </xsl:if>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="RECOMMENDTITLE">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 50)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                          <xsl:value-of select="//forminfo/maintable/RECOMMENDTITLE" />
                        </xsl:if>
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div id="__mainfield" name="RECOMMENDTITLE">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/RECOMMENDTITLE))" />
                      </div>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
