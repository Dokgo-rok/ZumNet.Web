        ...
        <div class="m">
                  ...
                  <h1>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <button onclick="parent.fnOption('external.groupcode',100,200,60,162,'','CORPORATION','COERPID','COERPSUBID');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" colspan="6" style="border-right:0">당월 작업불량 발생금액 비율 (A)</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="f-lbl" colspan="3" style="border-right:0">당월 총 불용재고 발생금액 비율 (A + B)</td>
              </tr>
              <tr>
                <td class="f-lbl">매출액</td>
