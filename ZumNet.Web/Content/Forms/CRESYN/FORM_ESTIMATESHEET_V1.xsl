...
<xsl:stylesheet  version="1.0"
		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m {width:706px;vertical-align:top;}
					...
					.m .fm-editor {height:600px;vertical-align:top;border:windowtext 0pt solid;}
					...
					.m .ft .f-lbl {width:72px;text-align:center}
							...
							<table border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="file-info">
										...
										<xsl:apply-templates select="//fileinfo/file"/>
									</td>
	...
	<xsl:template match="//fileinfo/file">
		<div>
			<a target="_blank">
				<xsl:attribute name="href">
