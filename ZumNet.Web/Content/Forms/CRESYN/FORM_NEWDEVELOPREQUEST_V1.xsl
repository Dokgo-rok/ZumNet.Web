      ...
      <body>
        <div class="m">
                  ...
                  <h1>
                    ...
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        &nbsp;(<select id="__mainfield" name="DEVTYPE" style="font-size:16pt;font-weight:bold">
                          <xsl:choose>
          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:236px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[(@bizrole='등급부서' or @bizrole='application' or @bizrole='manage') and @partid!='' and @step!='0'], '__si_Form', '3', '설계부서', '', 'BR')"/>
                </td>
                <td style="width:;font-size:1px">&nbsp;</td>
                <td style="width:164px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[(@bizrole='생산지' or @bizrole='confirm') and @partid!='' and @step!='0'], '__si_Form2', '2', '합의부서', '', 'BR')"/>
                </td>
                <td style="width:;font-size:1px">&nbsp;</td>
                <td style="width:92px">
          ...
          <xsl:choose>
            ...
            <xsl:when test="//forminfo/maintable/CONTENTS!='' and ($bizrole='last' or ($bizrole='의견' and $mode='read'))">
              <div class="fm">
                <table class="ft" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="f-lbl" style="border-bottom:0;width:88px">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td colspan="3">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="CUSTOMER" style="width:90%" class="txtText" maxlength="100" value="{//forminfo/maintable/CUSTOMER}" />                      
                ...
                <td style="border-right:0" colspan="2">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">                      
                      <input type="text" id="__mainfield" name="MODELNAME" style="width:84%" class="txtText" maxlength="100" value="{//forminfo/maintable/MODELNAME}" />
              ...
              <tr>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">                      
                      <input type="text" id="__mainfield" name="SHIPDATE" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" class="txtDate" maxlength="8" value="{//forminfo/maintable/SHIPDATE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:if test="$mlvl='A' or $mlvl='B'">
                        <xsl:attribute name="id">___editable</xsl:attribute>
                      ...
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/SHIPDATE))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>
                ...
                <td colspan="2">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <xsl:if test="$bizrole='생산지' and $actrole='_approver' and ($mlvl='A' or $mlvl='B')">
                        <xsl:attribute name="id">___editable</xsl:attribute>
                      </xsl:if>
                      <xsl:choose>
                        <xsl:when test="$bizrole='생산지' and $actrole='_approver' and $submode='revise'">
                          <input type="text" id="__mainfield" name="PRODUCTCENTER" readonly="readonly" class="txtText_u" style="width:85%" value="{//forminfo/maintable/PRODUCTCENTER}" />
                          <button onclick="parent.fnOption('external.centercode',240,140,100,120,'','PRODUCTCENTER');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                            <img alt="" class="blt01" style="margin:0 0 2px 0" src="/{//config/@root}/EA/Images/ico_28.gif" />
                          </button>
              ...
              <tr>
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">                      
                      <input type="text" id="__mainfield" name="DAY1" maxlength="8" class="txtDate" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" value="{//forminfo/maintable/DAY1}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:if test="$mlvl='A' or $mlvl='B'">
                        <xsl:attribute name="id">___editable</xsl:attribute>
                      ...
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          ...
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DAY1))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT1">
                        <xsl:attribute name="class">txtNumberic</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/COUNT1" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY2">
                        ...
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/DAY2" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT2">
                        <xsl:attribute name="class">txtNumberic</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/COUNT2" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY3">
                        <xsl:attribute name="class">txtDate</xsl:attribute>
                        <xsl:attribute name="maxlength">8</xsl:attribute>
                        <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/DAY3" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT3">
                        <xsl:attribute name="class">txtNumberic</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/COUNT3" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY4">
                        <xsl:attribute name="class">txtDate</xsl:attribute>
                        <xsl:attribute name="maxlength">8</xsl:attribute>
                        <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/DAY4" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT4">
                        <xsl:attribute name="class">txtNumberic</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/COUNT4" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY5">
                        <xsl:attribute name="class">txtDate</xsl:attribute>
                        <xsl:attribute name="maxlength">8</xsl:attribute>
                        <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/DAY5" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT5">
                        <xsl:attribute name="class">txtNumberic</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/COUNT5" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
          ...
          <div class="fm">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>
                  <span class="f-option" style="width:45px">
                    <input type="checkbox" id="ckb51" name="ckbEXMODELYN" value="Y">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbEXMODELYN', this, 'EXMODELYN')</xsl:attribute>
                      </xsl:if>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL1" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL1}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL2" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL2}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL3" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL3}" />
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL4" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL4}" />
              ...
              <tr>
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL5" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL5}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL6" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL6}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL7" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL7}" />
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL8" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL8}" />
              ...
              <tr>
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL9" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL9}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL10" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL10}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL11" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL11}" />
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL12" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL12}" />
              ...
              <tr>
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL13" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL13}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL14" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL14}" />
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL15" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL15}" />
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL16" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL16}" />
              ...
              <tr>
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL17" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL17}" />
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL18" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL18}" />
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL19" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL19}" />
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL20" class="txtText" maxlength="100" style="width:89%" value="{//forminfo/maintable/EXMODEL20}" />
          ...
          <div class="fm">
            <table border="0" cellspacing="0" cellpadding="0">
              <xsl:choose>
                <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
                  <tr>
                    <td>
                      <span>
                        예상투자비 내역
                        <font color="red" size="2">
                          ※ 예상투자비 내역 USD 기입(현지화 기입 필요시 비고란 사용)
                        </font>
                      </span>
                    </td>                    
                    <td class="fm-button">
              ...
              <tr>
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1" border="0" cellspacing="0" cellpadding="0">
                    <xsl:if test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
                      <xsl:attribute name="style">table-layout:fixed</xsl:attribute>
                    </xsl:if>
                    <colgroup>
                    ...
                    <tr>
                      ...
                      <td class="f-lbl-sub" style="border-top:0;">고객부담금액</td>
                      <!--<td class="f-lbl-sub" style="border-top:0;">투자부담</td>-->
                ...
                <td class="fm-button">
                  ...
                  <!--<span class="f-option" style="width:45px">
                    <input type="checkbox" id="ckb15" name="ckbTERM" value="1회">
                      <xsl:if test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbTERM', this, 'TERM')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/TERM),'1회')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="($mode='new' or $mode='edit') or (not ($bizrole='yeongeob' and $actrole='_approver' and $partid!='') and $mode='read' and phxsl:isDiff(string(//forminfo/maintable/TERM),'1회'))">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb15">1회</label>
                  </span>
                  <span class="f-option" style="width:40px">
                    <input type="checkbox" id="ckb11" name="ckbTERM" value="월">
                      ...
                      <xsl:if test="($mode='new' or $mode='edit') or (not ($bizrole='yeongeob' and $actrole='_approver' and $partid!='') and $mode='read' and phxsl:isDiff(string(//forminfo/maintable/TERM),'월'))">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb11">월</label>
                  </span>
                  <span class="f-option" style="width:50px">
                    <input type="checkbox" id="ckb12" name="ckbTERM" value="분기">
                      ...
                      <xsl:if test="($mode='new' or $mode='edit') or (not ($bizrole='yeongeob' and $actrole='_approver' and $partid!='') and $mode='read' and phxsl:isDiff(string(//forminfo/maintable/TERM),'분기'))">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb12">분기</label>
                  </span>
                  <span class="f-option" style="width:50px">
                    <input type="checkbox" id="ckb13" name="ckbTERM" value="반기">
                      ...
                      <xsl:if test="($mode='new' or $mode='edit') or (not ($bizrole='yeongeob' and $actrole='_approver' and $partid!='') and $mode='read' and phxsl:isDiff(string(//forminfo/maintable/TERM),'반기'))">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb13">반기</label>
                  </span>
                  <span class="f-option" style="width:40px">
                    <input type="checkbox" id="ckb14" name="ckbTERM" value="년">
                      ...
                      <xsl:if test="($mode='new' or $mode='edit') or (not ($bizrole='yeongeob' and $actrole='_approver' and $partid!='') and $mode='read' and phxsl:isDiff(string(//forminfo/maintable/TERM),'년'))">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb14">년</label>
                  </span>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="SALEPRICE" class="txtDollar" maxlength="20" value="{//forminfo/maintable/SALEPRICE}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PLANCOUNT" class="txtCurrency" maxlength="20" value="{//forminfo/maintable/PLANCOUNT}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PLANCOUNT))" />&nbsp;/&nbsp;<xsl:value-of select="//forminfo/maintable/TERM"></xsl:value-of>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PREDICTSALES" class="txtRead" readonly="readonly" value="{//forminfo/maintable/PREDICTSALES}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PREDICTSALES))" />&nbsp;/&nbsp;<xsl:value-of select="//forminfo/maintable/TERM"></xsl:value-of>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
              <tr>
                <td class="f-lbl4" rowspan="3">개발견적가</td>
                <td class="f-lbl4">재료비</td>
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVPRICEA" class="txtDollar" maxlength="20" value="{//forminfo/maintable/DEVPRICEA}" />
                    </xsl:when>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVPRICEA" class="txtRead" readonly="readonly" value="{//forminfo/maintable/DEVPRICEA}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEVPRICEA))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="MCRATE" class="txtDollar" maxlength="20" value="{//forminfo/maintable/MCRATE}" />
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl4">가공비</td>
                <td colspan="4" style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
                      가공비합&nbsp;:&nbsp;<input type="text" id="__mainfield" name="DEVPRICEB" class="txtRead" readonly="readonly" style="width:100px" value="{//forminfo/maintable/DEVPRICEB}" />&nbsp;&nbsp;
                      (&nbsp;내작&nbsp;:&nbsp;<input type="text" id="__mainfield" name="DEVPRICEBA" class="txtDollar" maxlength="20" style="width:100px" value="{//forminfo/maintable/DEVPRICEBA}" />&nbsp;&nbsp;
                      외주&nbsp;:&nbsp;<input type="text" id="__mainfield" name="DEVPRICEBB" class="txtDollar" maxlength="20" style="width:100px" value="{//forminfo/maintable/DEVPRICEBB}" />&nbsp;)
                    </xsl:when>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      가공비합&nbsp;:&nbsp;<input type="text" id="__mainfield" name="DEVPRICEB" class="txtRead" readonly="readonly" style="width:100px" value="{//forminfo/maintable/DEVPRICEB}" />&nbsp;&nbsp;
                      (&nbsp;내작&nbsp;:&nbsp;<input type="text" id="__mainfield" name="DEVPRICEBA" class="txtRead" readonly="readonly" style="width:100px" value="{//forminfo/maintable/DEVPRICEBA}" />&nbsp;&nbsp;
                      외주&nbsp;:&nbsp;<input type="text" id="__mainfield" name="DEVPRICEBB" class="txtRead" readonly="readonly" style="width:100px" value="{//forminfo/maintable/DEVPRICEBB}" />&nbsp;)
                    </xsl:when>
                    <xsl:otherwise>
                      가공비합&nbsp;:&nbsp;<xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEVPRICEB))" />&nbsp;&nbsp;
                      (&nbsp;내작&nbsp;:&nbsp;<xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEVPRICEBA))" />&nbsp;&nbsp;
                      외주&nbsp;:&nbsp;<xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEVPRICEBB))" />&nbsp;)
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
              <tr>
                <td class="f-lbl4">관리비</td>
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVPRICEC" class="txtDollar" maxlength="20" value="{//forminfo/maintable/DEVPRICEC}" />
                    </xsl:when>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVPRICEC" class="txtRead" readonly="readonly" value="{//forminfo/maintable/DEVPRICEC}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEVPRICEC))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                <td class="f-lbl4">TOTAL</td>
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="($bizrole='manage' or $bizrole='yeongeob') and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVELOPPRICE" class="txtRead" readonly="readonly" value="{//forminfo/maintable/DEVELOPPRICE}" />
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl4">예상투자비</td>
                <td>
                  <xsl:choose>
                    <xsl:when test="($bizrole='manage' or $bizrole='yeongeob') and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PREDICTINVEST" class="txtRead" readonly="readonly" value="{//forminfo/maintable/PREDICTINVEST}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td class="f-lbl4">투자비회수방법</td>
                <td colspan="3" style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PREDICTWAY" class="txtText" maxlength="50" value="{//forminfo/maintable/PREDICTWAY}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PREDICTWAY))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
              <tr>                
                <td class="f-lbl4" style="border-bottom:0">개당예상이익</td>
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PREDICTPERPROFIT" class="txtRead" readonly="readonly" value="{//forminfo/maintable/PREDICTPERPROFIT}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td class="f-lbl4" style="border-bottom:0">총예상이익</td>
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PREDICTPROFIT" class="txtRead" readonly="readonly" value="{//forminfo/maintable/PREDICTPROFIT}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PREDICTPROFIT))" />&nbsp;/&nbsp;<xsl:value-of select="//forminfo/maintable/TERM"></xsl:value-of>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PREDICTRATE" class="txtRead" readonly="readonly" value="{//forminfo/maintable/PREDICTRATE}" />
                    </xsl:when>
                    <xsl:otherwise>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="SALEPRICE">
                        <xsl:attribute name="class">txtDollar</xsl:attribute>
                        <xsl:attribute name="maxlength">20</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/SALEPRICE" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="MCRATE">
                        <xsl:attribute name="class">txtDollar</xsl:attribute>
                        <xsl:attribute name="maxlength">20</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/MCRATE" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl4">개발견적가</td>
                <td>
                  <xsl:choose>
                    <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVELOPPRICE">
                        <xsl:attribute name="class">txtDollar</xsl:attribute>
                        <xsl:attribute name="maxlength">20</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/DEVELOPPRICE" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="DEVELOPPRICE" class="txtDollar" readonly="readonly" style="border:0"  value="{//forminfo/maintable/DEVELOPPRICE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEVELOPPRICE))" />
                    </xsl:otherwise>
              ...
              <tr>               
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PLANCOUNT">
                        <xsl:attribute name="class">txtCurrency</xsl:attribute>
                        <xsl:attribute name="maxlength">20</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/PLANCOUNT" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl4" style="">예상이익율(%)</td>
                <td style="">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
              ...
              <tr>
                <td class="f-lbl4" style="border-bottom:0;height:60px">투자비회수방법</td>
                <td colspan="3" style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$bizrole='yeongeob' and $actrole='_approver' and $partid!=''">
                      <textarea id="__mainfield" name="PREDICTWAY" style="height:50px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 500)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                          <xsl:value-of select="//forminfo/maintable/PREDICTWAY" />
                        </xsl:if>
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="PREDICTWAY" style="height:50px">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>                    
                    <xsl:when test="$mode='new' or $mode='edit' ">
                      <textarea id="__mainfield" name="CUSTOMERREQ" style="height:120px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 2000)</xsl:attribute>
                    ...
                    <xsl:otherwise>                     
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="CUSTOMERREQ" class="txaText" style="height:120px" onclick="parent.checkTextAreaLength(this, 2000)" >
                        ...
                        <xsl:otherwise>
                          <div id="__mainfield" name="CUSTOMERREQ" style="height:120px">
                            <xsl:attribute name="class">txaRead</xsl:attribute>
    ...
    <tr class="sub_table_row">
     ...
     <td>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
            <input type="text" name="PREDICTPRICE">
              <xsl:attribute name="class">txtDollar</xsl:attribute>
              <xsl:attribute name="maxlength">20</xsl:attribute>
              <xsl:attribute name="value">
                <xsl:value-of select="PREDICTPRICE" />
              </xsl:attribute>
            </input>
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$bizrole='manage' and $actrole='_approver' and $partid!=''">
            <input type="text" name="PREDICTPRICE2">
              <xsl:attribute name="class">txtDollar</xsl:attribute>
              <xsl:attribute name="maxlength">20</xsl:attribute>
              <xsl:attribute name="value">
                <xsl:value-of select="PREDICTPRICE2" />
              </xsl:attribute>
            </input>
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(PREDICTPRICE2))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <!--<td style="text-align:center">
        <span class="f-option">
          <input type="checkbox" name="ckbINVESTMENT" value="당사">
            <xsl:attribute name="id">ckb.<xsl:value-of select="ROWSEQ" />.A</xsl:attribute>
            <xsl:if test="$mode='new' or $mode='edit'">
              <xsl:attribute name="onclick">parent.fnTableCheckYN('ckbINVESTMENT', this, 'INVESTMENT')</xsl:attribute>
            </xsl:if>
            <xsl:if test="phxsl:isEqual(string(INVESTMENT),'당사')">
              <xsl:attribute name="checked">true</xsl:attribute>
            </xsl:if>
            <xsl:if test="$mode='read' and phxsl:isDiff(string(INVESTMENT),'당사')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
          <label>
            <xsl:attribute name="for">ckb.<xsl:value-of select="ROWSEQ" />.A</xsl:attribute>당사
          </label>
        </span>
        <span class="f-option">
          <input type="checkbox" name="ckbINVESTMENT" value="고객">
            <xsl:attribute name="id">ckb.<xsl:value-of select="ROWSEQ" />.B</xsl:attribute>
            <xsl:if test="$mode='new' or $mode='edit'">
              <xsl:attribute name="onclick">parent.fnTableCheckYN('ckbINVESTMENT', this, 'INVESTMENT')</xsl:attribute>
            </xsl:if>
            <xsl:if test="phxsl:isEqual(string(INVESTMENT),'고객')">
              <xsl:attribute name="checked">true</xsl:attribute>
            </xsl:if>
            <xsl:if test="$mode='read' and phxsl:isDiff(string(INVESTMENT),'고객')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
          <label>
            <xsl:attribute name="for">ckb.<xsl:value-of select="ROWSEQ" />.B</xsl:attribute>고객
          </label>
        </span>
