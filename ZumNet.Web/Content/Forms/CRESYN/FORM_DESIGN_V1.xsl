			...
			<body>
				<div class="m">
					...
					<div class="fm2">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="f-lbl">작&nbsp;업&nbsp;구&nbsp;분</td>
								<td style="width: 108px;;" align="center">
									<xsl:choose>
										<xsl:when test="$mode='read'">
											<input type="text" name="WORKTYPE1" id="__mainfield">
												<xsl:attribute name="class">txtRead</xsl:attribute>
												<xsl:attribute name="readonly">readonly</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/WORKTYPE" />
												</xsl:attribute>
											</input>
										</xsl:when>
										<xsl:otherwise>
											<select class="txtRead" onchange="parent.fnChangeDesign(this.value)">
												<xsl:choose>
													<xsl:when test="//forminfo/maintable/WORKTYPE[.='']">
														<option value="웹프로젝트" selected="true">웹프로젝트</option>
														<option value="제안">제안</option>
														<option value="행사">행사</option>
														<option value="기타">기타</option>
													</xsl:when>
													<xsl:when test="//forminfo/maintable/WORKTYPE[.='웹프로젝트']">
														<option value="웹프로젝트" selected="true">웹프로젝트</option>
														<option value="제안">제안</option>
														<option value="행사">행사</option>
														<option value="기타">기타</option>
													</xsl:when>
													<xsl:when test="//forminfo/maintable/WORKTYPE[.='제안']">
														<option value="웹프로젝트">웹프로젝트</option>
														<option value="제안" selected="true">제안</option>
														<option value="행사">행사</option>
														<option value="기타">기타</option>
													</xsl:when>
													<xsl:when test="//forminfo/maintable/WORKTYPE[.='행사']">
														<option value="웹프로젝트">웹프로젝트</option>
														<option value="제안">제안</option>
														<option value="행사" selected="true">행사</option>
														<option value="기타">기타</option>
													</xsl:when>
													<xsl:when test="//forminfo/maintable/WORKTYPE[.='기타']">
														<option value="웹프로젝트">웹프로젝트</option>
														<option value="제안">제안</option>
														<option value="행사">행사</option>
							...
							<tr>
								<td class="f-lbl">작&nbsp;&nbsp;&nbsp;업&nbsp;&nbsp;&nbsp;명</td>
								<td  style="border-right:0;" colspan="3">
									<input type="text" name="WORKNAME" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/WORKNAME" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl"  style="border-bottom:0;">의&nbsp;뢰&nbsp;기&nbsp;간</td>
								<td style="border-right:0;border-bottom:0;" colspan="3">
									<input type="text" name="REQSDATE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/REQSDATE" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
									...
									<input type="text" name="REQEDATE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:80px</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/REQEDATE" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
						...
						<xsl:choose>
							...
							<xsl:otherwise>
								...
								<iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no">
									<xsl:attribute name="src">
										/<xsl:value-of select="$root" />/EA/External/Editor_tagfree.aspx?doctype=DesignWorkWeb.htm
									</xsl:attribute>
								</iframe>
							</xsl:otherwise>
						</xsl:choose>
				...
				<xsl:element name="input">
					...
					<xsl:attribute name="name">WORKTYPE</xsl:attribute>
					<xsl:attribute name="value">
						<xsl:value-of select="//forminfo/maintable/WORKTYPE"/>
					</xsl:attribute>
				</xsl:element>
