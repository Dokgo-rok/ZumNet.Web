  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td class="tdRead_Center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text_u" name="NFROMTIME" readonly="readonly"  class="txtHHmm" data-inputmask="time;HH:MM" value="22:00" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td class="tdRead_Center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="NTOTIME" class="txtHHmm" maxlength="5" data-inputmask="time;HH:MM" value="{NTOTIME}" />
          </xsl:when>
          <xsl:otherwise>
