				...
				<div class="m">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="f-lbl4" style="border-bottom:0">실적</td>
								<td style="border-bottom: 0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE1" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE1}" />
								...
								<td style="border-bottom: 0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE7" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE7}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE7))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
								<td style="border-bottom: 0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE8" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE8}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE8))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
								<td style="border-bottom: 0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE9" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE9}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE9))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
								<td style="border-bottom: 0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE10" class="txtText" maxlength="10" value="{//forminfo/maintable/ENFORCEDATE10}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE10))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
								<td>
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE11" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE11}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE11))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
									<td style="border-bottom: 0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE12" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE12}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE12))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
								<td style="border-bottom: 0; border-right:0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<input type="text" id="__mainfield" name="ENFORCEDATE13" class="datepicker-slash txtDateSlash" maxlength="10" data-inputmask="date;yyyy/MM/dd" value="{//forminfo/maintable/ENFORCEDATE13}" />
										</xsl:when>
										<xsl:otherwise>
											<xsl:attribute name="class">tdRead_Center</xsl:attribute>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ENFORCEDATE13))" />
										</xsl:otherwise>
									</xsl:choose>
								</td>
							</tr>
                                ...
                                /<xsl:value-of select="$root"/>/EA/Images/ico_28.gif
									...
									<div class="fm">
										<table class="ft" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td class="f-lbl4" style="font-size:11px;padding:0;border-bottom:0" rowspan="2">
													개당<br />이익율<br />(%)
												</td>
