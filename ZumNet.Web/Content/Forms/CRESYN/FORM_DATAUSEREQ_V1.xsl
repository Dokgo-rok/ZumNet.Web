		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .ft .f-lbly {width:100;text-align:center}
				...
				<div class="m">
							...
							<tr>
								<td style="width:50%">
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='normal' and @partid!='' and @step!='0'], '__si_Normal', '3')"/>
											</td>
										</tr>
									</table>
								</td>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='receive' and @partid!='' and @actrole!='__r' and @step!='0'], '__si_Receive', '4')"/>
											</td>
										</tr>
									</table>
								</td>
					...
					<div class="fm">
						<table  class="ft" border="0" cellspacing="0" cellpadding="0" style="border-bottom:0;">
							<tr>
								<td class="f-lbl">요청사유</td>
								<td class="f-lbly">Demo 개발</td>
								<td class="f-lbly">
									<input type="checkbox" name="CHECK1" id="__mainfield">
										<xsl:attribute name="value">Y</xsl:attribute>
										<xsl:if test="$mode!='new'">
											<xsl:choose>
												<xsl:when test="//forminfo/maintable/CHECK1='Y'">
								...
								<td class="f-lbly">자체 개발</td>
								<td class="f-lbly">
									<input type="checkbox" name="CHECK2" id="__mainfield">
										<xsl:attribute name="value">Y</xsl:attribute>
										<xsl:if test="$mode!='new'">
											<xsl:choose>
												<xsl:when test="//forminfo/maintable/CHECK2='Y'">
													<xsl:attribute name="checked">true</xsl:attribute>
												</xsl:when>
												<xsl:otherwise>
													<xsl:attribute name="checked">false</xsl:attribute>
								...
								<td class="f-lbly">수령희망일</td>
								<td class="f-lbl"  style="border-right:0;">
									<input type="text" name="WDAY" id="__mainfield">
										<xsl:choose>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">12</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/WDAY" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbly" rowspan="2" style="border-bottom:0;">사용계획</td>
								<td class="f-lbly">개발명</td>
								<td colspan="5" style="border-right:0">
									<input type="text" name="DNAME" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/DNAME" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl" style="border-bottom:0;">주요 내용</td>
								<td colspan="5" style="border-right:0;border-bottom:0;height:100px;vertical-align:top">
									<xsl:choose>
										<xsl:when test="$mode='read'">
											<div name="REQUEST" id="__mainfield">
												<xsl:attribute name="class">txaRead</xsl:attribute>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:replaceTextArea(string(//forminfo/maintable/REQUEST))" />
											</div>
										</xsl:when>
										<xsl:otherwise>
											<textarea name="REQUEST" id="__mainfield">
						...
						<table  class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="3" style="border-right:0;text-align:center;">요청내용</td>
							</tr>
							<tr>
								<td class="f-lbl" colspan="2">Data 좌표</td>
								<td  style="border-right:0;">
									<input type="text" name="DATAXY" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">200</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/DATAXY" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl" rowspan="2">범위</td>
								<td class="f-lbl">공간적범위</td>
								<td  style="border-right:0;">
									<input type="text" name="SCOPE1" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">200</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">200</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/SCOPE1" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl">내용적범위</td>
								<td  style="border-right:0;">
									<input type="text" name="SCOPE2" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">200</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">200</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/SCOPE2" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl" colspan="2">적용형식</td>
								<td  style="border-right:0;">
									<input type="text" name="SUPPLAYTYPE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">200</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">200</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/SUPPLAYTYPE" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl" style="border-bottom:0;" colspan="2">주요 내용</td>
								<td style="border-right:0;border-bottom:0;height:100px;vertical-align:top">
									<xsl:choose>
										<xsl:when test="$mode='read'">
