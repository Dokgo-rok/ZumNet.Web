      ...
      <body>
        <div class="m">
          ...
          <div class="fm">
            <table border="0" cellspacing="0" cellpadding="0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'  or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
                  <tr>
                    <td>
                      <span>&nbsp;</span>
                    </td>
              ...
              <tr>
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    <xsl:if test="$mode='new' or $mode='edit' or ($bizrole='receive' and $actrole='_reviewer') or ($bizrole='receive' and $actrole='__r')">
					  ...
					  <tr style="height:40px">
						  ...
						  <td class="f-lbl-sub" style="border-top:0">임시가</td>
                    ...
                    <tr>
                      ...
                      <td colspan="" style="border-bottom:0;border-right:0">&nbsp;</td>
                    </tr>
                  </table>
                </td>
              </tr>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
	  <tr class="sub_table_row">
		  ...
		  <td>
			  <xsl:choose>
				  <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
					  <input type="text" name="MODELNAME" style="width:87%">
						  <xsl:attribute name="class">txtText</xsl:attribute>
						  <xsl:attribute name="value">
		  ...
		  <td>
			  <xsl:choose>
				  <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
					  <input type="text" name="ITEMNO" style="width:84%">
						  <xsl:attribute name="class">txtText_u</xsl:attribute>
						  <xsl:attribute name="readonly">readonly</xsl:attribute>
						  <xsl:attribute name="value">
		  ...
		  <td>
			  <xsl:choose>
				  <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
					  <input type="text" name="PRICEC" class="txtDollar" maxlength="20" data-inputmask="number;15;5" value="{PRICEC}" />
				  </xsl:when>
				  <xsl:otherwise>
					  <xsl:attribute name="class">tdRead_Right</xsl:attribute>
		  ...
		  <td>
			  <xsl:choose>
				  <xsl:when test="$mode='new' or $mode='edit'  or $actrole='__r' or $actrole='_reviewer'">
					  <input type="text" name="UOM" style="width:65%" class="txtText_u" readonly="readonly" value="{UOM}" />
		  ...
		  <td>
			  <xsl:choose>
				  <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
					  <input type="text" name="COMPANY" style="width:89%">
						  <xsl:attribute name="class">txtText_u</xsl:attribute>
						  <xsl:attribute name="readonly">readonly</xsl:attribute>
						  <xsl:attribute name="value">
