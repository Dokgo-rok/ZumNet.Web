    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .m .ft .f-lbl {width:13%} .m .ft .f-lbl1 {width:15%} .m .ft .f-lbl2 {width:?}
        ...
        <div class="m">
                  ...
                  <h1>
                    ...
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        (<select id="__mainfield" name="ACTIONTYPE" style="font-size:14pt;font-weight:bold">
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/ACTIONTYPE),'')">
                          ...
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/ACTIONTYPE),'시정조치')">
                              <option value="시정조치" selected="selected">시정조치</option>
                            </xsl:when>
                            <xsl:otherwise>
                              <option value="시정조치">시정조치</option>
                            </xsl:otherwise>
                          </xsl:choose>
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/ACTIONTYPE),'예방조치')">
                              <option value="예방조치" selected="selected">예방조치</option>
                            </xsl:when>
                            <xsl:otherwise>
                              <option value="예방조치">예방조치</option>
                            </xsl:otherwise>
                          </xsl:choose>
                        </select>)
                      </xsl:when>
                      <xsl:otherwise>
                        <span style="font-size:14pt;font-weight:bold" >
                          (<xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/ACTIONTYPE),'시정조치')">시정조치</xsl:when>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/ACTIONTYPE),'예방조치')">예방조치</xsl:when>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:37%">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="CORPORATION" style="width:92%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/CORPORATION}" />
                      <button onclick="parent.fnOption('external.centercode',200,200,140,150,'','CORPORATION');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                ...
                <td class="f-lbl">감사기간</td>
                <td style="width:37%;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="AUDITFROM" class="txtDate" maxlength="8" style="width:80px" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/AUDITFROM}" />
                    </xsl:when>
                    <xsl:otherwise>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="AUDITTO" class="txtDate" maxlength="8" style="width:80px" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/AUDITTO}" />
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl">감사구분</td>
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="AUDITTYPE" style="width:92%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/AUDITTYPE}" />
                      <button onclick="parent.fnOption('external.audittype',200,130,140,116,'etc','AUDITTYPE');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                        <img alt="" class="blt01" style="margin:0 0 2px 0" src="/{//config/@root}/EA/Images/ico_28.gif" />
                      </button>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td class="f-lbl">분류구분</td>
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <select id="__mainfield" name="DIVIDETYPE" style="width:70%">
                        <xsl:choose>
                          <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'')">
                            <option value="" selected="selected">선택</option>
                          </xsl:when>
                          <xsl:otherwise>
                            <option value="">선택</option>
                        ...
                        <xsl:choose>
                          <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'개선권고')">
                            <option value="개선권고" selected="selected">개선권고</option>
                          </xsl:when>
                          <xsl:otherwise>
                            <option value="개선권고">개선권고</option>
                          </xsl:otherwise>
                        </xsl:choose>
                        <xsl:choose>
                          <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'중부적합')">
                            <option value="중부적합" selected="selected">중부적합</option>
                          </xsl:when>
                          <xsl:otherwise>
                        ...
                        <xsl:choose>
                          <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'경부적합')">
                            <option value="경부적합" selected="selected">경부적합</option>
                          </xsl:when>
                          <xsl:otherwise>
                        ...
                        <xsl:choose>
                          <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'관찰사항')">
                            <option value="관찰사항" selected="selected">관찰사항</option>
                          </xsl:when>
                          <xsl:otherwise>
                    ...
                    <xsl:otherwise>
                      <xsl:choose>
                        <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'개선권고')">개선권고</xsl:when>
                        <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'중부적합')">중부적합</xsl:when>
                        <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'경부적합')">경부적합</xsl:when>
                        <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DIVIDETYPE),'관찰사항')">관찰사항</xsl:when>
                        <xsl:otherwise>&nbsp;</xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0">감사자</td>
                <td style="width:37%;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="AUDITOR" style="" class="txtText" value="{//forminfo/maintable/AUDITOR}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/AUDITOR))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                <td class="f-lbl" style="border-bottom:0">회신요청일</td>
                <td style="width:37%;border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="REPLYDATE" style="width:80px" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/REPLYDATE}" />
                    </xsl:when>
                    <xsl:otherwise>
          ...
          <div class="fm">
            <span>2. 원인 분석</span>
            <span style="padding-left:15px">(6하원칙에 준하여 서술형으로 작성)</span>
          </div>
          ...
          <div class="fm">
            <span>3. 조치 사항</span>
            <span style="padding-left:15px">(6하 원칙에 준하여 조치내용, 재발방지대책 순으로 서술형 작성)</span>
          </div>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0">조치자</td>
                ...
                <td class="f-lbl" style="width:27%;border-bottom:0">조치완료 또는 예정일자</td>
                <td style="width:30%;border-right:0;border-bottom:0;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" name="ACTIONDATE" style="width:40%" class="txtRead" readonly="readonly" />
                    </xsl:when>
                    <xsl:when test="$bizrole='receive' and $actrole='__r' and $partid!=''">
                      <input type="text" id="__mainfield" name="ACTIONDATE" style="width:80px" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/ACTIONDATE}" />
                    </xsl:when>
                    <xsl:otherwise>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl">조치내용검토<br />(불만족사유등)</td>
                <td style="width:37%;border-right:0" colspan="4">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
              ...
              <tr>
                ...
                <td class="f-lbl" style="border-bottom:0">확인일자</td>
                <td style="width:37%;border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
              ...
              <!--<tr>
                <td class="f-lbl" style="border-bottom:0">유효성검증</td>
                <td style="border-bottom:0">
                  <span class="f-option1">
                    <input type="checkbox" id="ckb11" name="ckbRESULTTYPE1" value="완료">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/RESULTTYPE1),'완료')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:choose>
                        <xsl:when test="$bizrole='application' and $actrole='__r' and $partid!=''">
                          <xsl:attribute name="onclick">parent.fnCheckYN('ckbRESULTTYPE1', this, 'RESULTTYPE1')</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/RESULTTYPE1),'완료')">
                            <xsl:attribute name="disabled">disabled</xsl:attribute>
                          </xsl:if>
                        </xsl:otherwise>
                      </xsl:choose>
                  ...
                  <span class="f-option1">
                    <input type="checkbox" id="ckb12" name="ckbRESULTTYPE1" value="미완료">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/RESULTTYPE1),'미완료')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:choose>
                        <xsl:when test="$bizrole='application' and $actrole='__r' and $partid!=''">
                        ...
                        <xsl:otherwise>
                          <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/RESULTTYPE1),'미완료')">
                            <xsl:attribute name="disabled">disabled</xsl:attribute>
                          </xsl:if>
                        </xsl:otherwise>
                      </xsl:choose>
                  ...
                  <input type="hidden" id="__mainfield" name="RESULTTYPE1">
                    <xsl:attribute name="value">
                      <xsl:value-of select="//forminfo/maintable/RESULTTYPE1"></xsl:value-of>
                    </xsl:attribute>
                  </input>
                </td>
                <td class="f-lbl" style="border-bottom:0">검증완료<br/>(예정)일자</td>           
                  <td style="width:37%;border-right:0;border-bottom:0">
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        <input type="text" name="VERIFYDATE1" style="width:40%" class="txtRead" readonly="readonly" />
                      </xsl:when>
                      <xsl:when test="$bizrole='application' and $actrole='__r' and $partid!=''">
                        <input type="text" id="__mainfield" name="VERIFYDATE1" style="width:40%" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/VERIFYDATE}" />
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/VERIFYDATE1))" />
                      </xsl:otherwise>
                    </xsl:choose>
                  </td>          
              </tr>-->              
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="f-lbl" style="border-bottom:0">완료일</td>
                <td style="width:37%;border-right:0;border-bottom:0;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
