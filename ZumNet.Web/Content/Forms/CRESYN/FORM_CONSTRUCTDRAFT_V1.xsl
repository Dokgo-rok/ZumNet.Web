                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0">공사명</td>
                      <td class="f-lbl-sub" style="border-top:0">공사장소</td>
                      <td class="f-lbl-sub" style="border-top:0">공사사유</td>
                      <td class="f-lbl-sub" style="border-top:0">공사내역</td>
                      <td class="f-lbl-sub" style="border-top:0">견적금액</td>
                      <td class="f-lbl-sub" style="border-top:0">결정금액</td>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="CONSTRUCTNAME">
              <xsl:attribute name="class">txtText</xsl:attribute>
              <xsl:attribute name="maxlength">50</xsl:attribute>
              <xsl:attribute name="value">
                <xsl:value-of select="CONSTRUCTNAME" />
              </xsl:attribute>
            </input>
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(CONSTRUCTNAME))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
