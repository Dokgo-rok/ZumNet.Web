        ...
        <div class="m">
                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="3"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td class="f-lbl-sub" style="" rowspan="2">부서</td>
                      <td class="f-lbl-sub" style="" rowspan="2">사번</td>
                      <td class="f-lbl-sub" style="" rowspan="2">직위</td>
                      <td class="f-lbl-sub" style="" rowspan="2">이름(한글)</td>
                      <td class="f-lbl-sub" style="" colspan="2">Name(English)</td>
                      <td class="f-lbl-sub" style="" rowspan="2">E-mail ID</td>                      
                      <td class="f-lbl-sub" style="" rowspan="2">E-mail</td>
                    ...
                    <tr>
                      ...
                      <td class="f-lbl-sub" style="">이름(First)</td>
                    </tr>
          ...
          <div align="left">
            <font color="red" size="2">
              1. 영문이름 필수입력 &nbsp;&nbsp;2. 직위가 '현지인'이 아닌 경우 한글 이름 필수 &nbsp;&nbsp;3. 소속이 중국이라면 중문이름 필수(주재원 + 현지인)<br />
              4. 문서작성자는 신청대상자에 신규입사자가 포함되어 있을 시 입사일자를 결재의견 란에 기입한다<br />
              5. E-mail ID를 보유하고 있는 사용자가 기타 시스템 계정 요청 시  ID 필수입력(@cresyn.com 생략)
            </font>
          </div>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="DEPARTMENT" style="width:81%">
        ...
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="USERNUM">
              ...
              <xsl:attribute name="value">
                <xsl:value-of select="USERNUM" />
              </xsl:attribute>
            </input>
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(USERNUM))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <select name="JOBCLASS" style="">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'부사장')">
                  <option value="부사장" selected="selected">부사장</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'전무')">
                  <option value="전무" selected="selected">전무</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'상무')">
                  <option value="상무" selected="selected">상무</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'이사')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'실장')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'부장')">
                  <option value="부장" selected="selected">부장</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'수석연구원')">
                  <option value="수석연구원" selected="selected">수석연구원</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'차장')">
                  <option value="차장" selected="selected">차장</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'책임연구원')">
                  <option value="책임연구원" selected="selected">책임연구원</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'과장')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'대리')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'선임연구원')">
                  <option value="선임연구원" selected="selected">선임연구원</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'사원')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'연구원')">
                  <option value="연구원" selected="selected">연구원</option>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(JOBCLASS),'현지인')">
                  <option value="현지인" selected="selected">현지인</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="현지인">현지인</option>
                </xsl:otherwise>
              </xsl:choose>
            </select>
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(JOBCLASS))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <select name="CHECKKOREA" style="">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHECKKOREA),'한국인(Korean)')">
                  <option value="한국인(Korean)" selected="selected">한국인(Korean)</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="한국인(Korean)">한국인(Korean)</option>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHECKKOREA),'현지인(Natives)')">
                  <option value="현지인(Natives)" selected="selected">현지인(Natives)</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="현지인(Natives)">현지인(Natives)</option>
                </xsl:otherwise>
              </xsl:choose>
            </select>
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHECKKOREA))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="KORNAME">
              ...
              <xsl:attribute name="value">
                <xsl:value-of select="KORNAME" />
              </xsl:attribute>
            </input>
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(KORNAME))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(LASTNAME))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(FIRSTNAME))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(EMAILID))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>      
      <td style="text-align:center">
        <span class="f-option2">
          <input type="checkbox" name="ckbEMAIL" value="EMAIL">
            ...
            <xsl:if test="$mode='read' and phxsl:isDiff(string(CHECKEMAIL),'EMAIL')">
        ...
        <input type="hidden" name="CHECKEMAIL">
          <xsl:attribute name="value">
            <xsl:value-of select="CHECKEMAIL"></xsl:value-of>
          </xsl:attribute>
        </input>
      </td>
      <td style="text-align:center">
        <span class="f-option2">
          <input type="checkbox" name="ckbERP" value="ERP">
            ...
            <xsl:if test="$mode='read' and phxsl:isDiff(string(CHECKERP),'ERP')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
        </span>
        <input type="hidden" name="CHECKERP">
          <xsl:attribute name="value">
            <xsl:value-of select="CHECKERP"></xsl:value-of>
          </xsl:attribute>
        </input>
      </td>     
      <td style="text-align:center">
        <span class="f-option2">
          <input type="checkbox" name="ckbEKP" value="EKP">
            ...
            <xsl:if test="$mode='read' and phxsl:isDiff(string(CHECKEKP),'EKP')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
        </span>
        <input type="hidden" name="CHECKEKP">
          <xsl:attribute name="value">
            <xsl:value-of select="CHECKEKP"></xsl:value-of>
          </xsl:attribute>
        </input>
      </td>
      <td style="text-align:center">
        <span class="f-option2">
          <input type="checkbox" name="ckbVPN" value="VPN">
            ...
            <xsl:if test="$mode='read' and phxsl:isDiff(string(CHECKVPN),'VPN')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
        </span>
        <input type="hidden" name="CHECKVPN">
          <xsl:attribute name="value">
            <xsl:value-of select="CHECKVPN"></xsl:value-of>
          </xsl:attribute>
        </input>
      </td>
      <td style="text-align:center;width:60px">
        <span class="f-option2">
          <input type="checkbox" name="ckbSEC" value="SEC">
            ...
            <xsl:if test="$mode='read' and phxsl:isDiff(string(CHECKSEC),'SEC')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
        </span>
        <input type="hidden" name="CHECKSEC">
          <xsl:attribute name="value">
            <xsl:value-of select="CHECKSEC"></xsl:value-of>
          </xsl:attribute>
        </input>
      </td>
      <td style="text-align:center;border-right:0;width:60px">
        <span class="f-option2">
          <input type="checkbox" name="ckbACCU" value="ACCU">
            ...
            <xsl:if test="$mode='read' and phxsl:isDiff(string(CHECKACCU),'ACCU')">
              <xsl:attribute name="disabled">disabled</xsl:attribute>
            </xsl:if>
          </input>
        </span>
        <input type="hidden" name="CHECKACCU">
          <xsl:attribute name="value">
