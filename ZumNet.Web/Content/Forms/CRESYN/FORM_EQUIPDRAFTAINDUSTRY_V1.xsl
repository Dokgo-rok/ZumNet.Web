              ...
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      <div name="REASON" style="height:40px">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="CORPORATION" style="height:40px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 500);" >
                        <xsl:value-of select="//forminfo/maintable/CORPORATION" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="CORPORATION" style="height:40px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="SCHEDULE" style="height:40px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 500);" >
                        <xsl:value-of select="//forminfo/maintable/SCHEDULE" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="SCHEDULE" style="height:40px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="DESCRIPTION" style="height:60px" class="txaText" nkeyup="parent.checkTextAreaLength(this, 1000);" >
