            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="CRREGISTER" class="txtVolume" value="{//forminfo/maintable/CRREGISTER}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="CRSOLVE" class="txtVolume" value="{//forminfo/maintable/CRSOLVE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ROHSFIND" class="txtVolume" value="{//forminfo/maintable/ROHSFIND}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ROHSBAD" class="txtVolume" value="{//forminfo/maintable/ROHSBAD}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
              ...
              <tr>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="MAREGISTER" class="txtVolume" value="{//forminfo/maintable/MAREGISTER}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="MASOLVE" class="txtVolume" value="{//forminfo/maintable/MASOLVE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="HFFIND" class="txtVolume" value="{//forminfo/maintable/HFFIND}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="HFBAD" class="txtVolume" value="{//forminfo/maintable/HFBAD}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
              ...
              <tr>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="MIREGISTER" class="txtVolume" value="{//forminfo/maintable/MIREGISTER}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="MISOLVE" class="txtVolume" value="{//forminfo/maintable/MISOLVE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ETCFIND" class="txtVolume" value="{//forminfo/maintable/ETCFIND}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td  style="">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ETCBAD" class="txtVolume" value="{//forminfo/maintable/ETCBAD}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td style="border-bottom:0;border-right:0">
                  <span class="f-option">
                    <input type="checkbox" id="ckb11" name="ckbATTEND1" value="실폐사례">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbATTEND1', this, 'ATTEND1')</xsl:attribute>
                      </xsl:if>
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb12" name="ckbATTEND2" value="신제품">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbATTEND2', this, 'ATTEND2')</xsl:attribute>
                      </xsl:if>
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb13" name="ckbATTEND3" value="신뢰성">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbATTEND3', this, 'ATTEND3')</xsl:attribute>
                      </xsl:if>
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb14" name="ckbATTEND4" value="문제점">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbATTEND4', this, 'ATTEND4')</xsl:attribute>
                      </xsl:if>
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb15" name="ckbATTEND5" value="환경">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbATTEND5', this, 'ATTEND5')</xsl:attribute>
                      </xsl:if>
