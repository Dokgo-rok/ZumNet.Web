...
<xsl:stylesheet  version="1.0"
		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .fm span {font-size:13px;font-family:맑은 고딕;text-align:left;}
			...
			<body>
				<div class="m">
							...
							<tr>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='receive' and @partid!='' and @actrole!='__r'], '__si_Receive', '3')"/>
											</td>
										</tr>
									</table>
								</td>
					...
					<div class="fm" style="text-align:left">
						<span>1.&nbsp;출장&nbsp;계획
							<xsl:if test="$mode!='read'">
								<button onclick="arent.fnAddRow('__subtable1');" onfocus="this.blur()" class="btn_bg">
									출장계획서&nbsp;목록
								</button>
							</xsl:if>
						</span>
						...
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td colspan="3" style="border-right:0">
									<input type="text" name="PURPOSE" id="__mainfield">
										<xsl:attribute name="class">txtRead</xsl:attribute>
										<xsl:attribute name="readonly">readonly</xsl:attribute>
										<xsl:attribute name="value">
							...
							<tr>
								...
								<td style="width:37%">
									<input type="text" name="FROMDATE" id="__mainfield">
									...
									&nbsp;~&nbsp;
									<input type="text" name="TODATE" id="__mainfield">
										<xsl:attribute name="class">txtRead_Center</xsl:attribute>
										<xsl:attribute name="style">width:100px</xsl:attribute>
										<xsl:attribute name="readonly">readonly</xsl:attribute>
										<xsl:attribute name="value">
								...
								<td class="f-lbl">출&nbsp;&nbsp;장&nbsp;&nbsp;지</td>
								<td style="width:37%;border-right:0;">
									<input type="text" name="PLACE" id="__mainfield">
										<xsl:attribute name="class">txtRead</xsl:attribute>
										<xsl:attribute name="readonly">readonly</xsl:attribute>
										<xsl:attribute name="value">
							...
							<tr>
								<td class="f-lbl" style="border-bottom:0;">교&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;통</td>
								<td style="width:37%;border-bottom:0;">
									<input type="text" name="TRAFFIC" id="__mainfield">
										<xsl:attribute name="class">txtRead</xsl:attribute>
										<xsl:attribute name="readonly">readonly</xsl:attribute>
										<xsl:attribute name="value">
											<xsl:value-of select="//forminfo/maintable/TRAFFIC" />
										</xsl:attribute>
									</input>
								</td>
								<td class="f-lbl" style="border-bottom:0;">숙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;박</td>
								<td style="border-right:0;border-bottom:0;">
									<input type="text" name="STAYHOUSE" id="__mainfield">
										<xsl:attribute name="class">txtRead</xsl:attribute>
										<xsl:attribute name="readonly">readonly</xsl:attribute>
										<xsl:attribute name="value">
											<xsl:value-of select="//forminfo/maintable/STAYHOUSE" />
										</xsl:attribute>
									</input>
								</td>
							</tr>
					...
					<div class="fm2">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="f-lbl1">출&nbsp;장&nbsp;&nbsp;지</td>
								<td style="border-right:0;" colspan="3">
									<input type="text" name="PLACEREPORT" id="__mainfield">
										<xsl:choose>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">50</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/PLACEREPORT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl1" style="border-bottom:0;">출장기간</td>
								<td style="border-bottom:0;width:35%;">
									<input type="text" name="FROMDATEREPORT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/FROMDATEREPORT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
										...
										&nbsp;~&nbsp;
									<input type="text" name="TODATEREPORT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:100px</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/TODATEREPORT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
								...
								<td class="f-lbl1" style="border-bottom:0;">실출장일</td>
								<td style="border-right:0;border-bottom:0; ">
									<input type="text" name="DAYS" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">3</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/DAYS" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td colspan="2">
									<table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
										<tr style="height:25">
											<td class="f-lbl-sub" style="width:;border-top:0">Site-Proj</td>
											<td class="f-lbl-sub" style="width:80px;border-top:0">일자</td>
											<!--<td class="f-lbl-sub" style="width:80px;border-top:0">종료일</td>-->
											<!--<td class="f-lbl-sub" style="width:120px;border-top:0">출장지</td>-->
											<td class="f-lbl-sub" style="width:120px;border-top:0">항목</td>
											<td class="f-lbl-sub" style="width:100px;border-top:0">지출조건</td>
											<td class="f-lbl-sub" style="width:120px;border-top:0;">카드명</td>
											<td class="f-lbl-sub" style="width:90px;border-top:0;">금액</td>
											<td class="f-lbl-sub" style="width:200px;border-top:0;border-right:0">적요</td>
										</tr>
	...
	<xsl:template match="//forminfo/subtables/subtable1/row">
		<tr class="sub_table_row">
			...
			<td>
				<input type="text" name="BUSPROJECTNNAME">
					<xsl:choose>
						<xsl:when test="$mode='new' or $mode='edit'">
							<xsl:attribute name="class">txtText</xsl:attribute>
                            <xsl:attribute name="style">border:1px solid red</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="BUSPROJECTNNAME" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
				...
				<input type="text" name="BUSPROJECTNO" style="display:none;">
					<xsl:attribute name="value">
						<xsl:value-of select="BUSPROJECTNO" />
					</xsl:attribute>
				</input>
			</td>
			<td>
				<input type="text" name="BUSFROMDATE">
					<xsl:choose>
						<xsl:when test="$mode='new' or $mode='edit'">
							<xsl:attribute name="class">txtDate</xsl:attribute>
							<xsl:attribute name="maxlenth">8</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="BUSFROMDATE" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead_Center</xsl:attribute>
			...
			<!--
			<td>
				<input type="text" name="BUSTODATE">
					<xsl:choose>
						<xsl:when test="$mode='new' or $mode='edit'">
							<xsl:attribute name="class">txtDate</xsl:attribute>
							<xsl:attribute name="maxlenth">8</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="BUSTODATE" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead_Center</xsl:attribute>
			...
			<td style="height:20px;vertical-align:middle">
				<input type="text" name="BUSPLACE">
					<xsl:choose>
						<xsl:when test="$mode='new' or $mode='edit'">
							<xsl:attribute name="class">txtText</xsl:attribute>
							<xsl:attribute name="maxlenth">200</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="BUSPLACE" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
			...
			-->
			<td>
				<input type="text" name="BUSITEMNAME">
					<xsl:choose>
						<xsl:when test="$mode='new' or $mode='edit'">
							<xsl:attribute name="class">txtText</xsl:attribute>
                            <xsl:attribute name="style">border:1px solid red</xsl:attribute>
                            ...
                            <xsl:attribute name="style">border:1px solid red</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="BUSITEMNAME" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
					...
					<xsl:if test="$mode!='read'">
						<xsl:attribute name="onkeyup">parent.PROJECTNO_onkeyup('itembiz', this, '');</xsl:attribute>
					</xsl:if>
				</input>
			...
			<td style="border-right:0;">
				<input type="text" name="BIZCONTENTS">
					<xsl:choose>
						<xsl:when test="$mode='new' or $mode='edit'">
							<xsl:attribute name="class">txtText</xsl:attribute>
							<xsl:attribute name="maxlength">200</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="BIZCONTENTS" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
