  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td class="tdRead_Center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="OFROMTIME" class="txtHHmm" maxlength="5" data-inputmask="time;HH:MM" value="{OFROMTIME}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td class="tdRead_Center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="OTOTIME" class="txtHHmm" maxlength="5" data-inputmask="time;HH:MM" value="{OTOTIME}" />
          </xsl:when>
          <xsl:otherwise>
