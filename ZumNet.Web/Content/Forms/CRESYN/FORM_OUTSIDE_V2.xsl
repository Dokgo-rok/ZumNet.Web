  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td class="tdRead_Center">        
        <xsl:choose>                   
            <xsl:when test="$mode='new' or $mode='edit'">
              <select name="OUTSIDECODE" style="">
                <xsl:choose>
                  <xsl:when test="phxsl:isEqual(string(OUTSIDECODE),'')">
                ...
                <xsl:choose>
                  <xsl:when test="phxsl:isEqual(string(OUTSIDECODE),'직출')">
                ...
                <xsl:choose>
                  <xsl:when test="phxsl:isEqual(string(OUTSIDECODE),'직퇴')">
                    <option value="직퇴" selected="selected">직퇴</option>
                  </xsl:when>
                  <xsl:otherwise>
                ...
                <xsl:choose>
                  <xsl:when test="phxsl:isEqual(string(OUTSIDECODE),'직출및직퇴')">
                    <option value="직출및직퇴" selected="selected">직출및직퇴</option>
                  </xsl:when>
                  <xsl:otherwise>
                    <option value="직출및직퇴">직출및직퇴</option>
                  </xsl:otherwise>
                </xsl:choose>
              </select>
            </xsl:when>
            <xsl:otherwise>              
              <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(OUTSIDECODE))" />
            </xsl:otherwise>
        </xsl:choose>          
      </td>
      <td class="tdRead_Center">
