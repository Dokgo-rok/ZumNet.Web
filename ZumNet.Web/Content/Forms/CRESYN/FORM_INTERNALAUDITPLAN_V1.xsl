          ...
          <div class="fh">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="fh-m">
                  <h1>
					  내부감사계획서<br />(Internal Audit Plan)
				  </h1>
                </td>
                <td class="fh-r">&nbsp;</td>
              </tr>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="AUDITCONTENTS" style="height:150px" class="txaText bootstrap-maxlength" maxlength="3000">
                        <xsl:value-of select="//forminfo/maintable/AUDITCONTENTS" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div iclass="txaRead" style="height:150px">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="SPECIALTY" style="height:100px" class="txaText bootstrap-maxlength" maxlength="2000">
