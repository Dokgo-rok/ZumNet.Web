		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .txtRead_Center1 {border:0;padding-top:2px;text-align:center}
								...
								<td>
									<table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
										<tr style="height:25">
                                            ...
                                            <td class="f-lbl-sub" style="width:80px;border-top:0">물품구분</td>
											<td class="f-lbl-sub" style="width:;border-top:0">내용</td>
											<td class="f-lbl-sub" style="width:40px;border-top:0">수량</td>
											<td class="f-lbl-sub" style="width:60px;border-top:0;">단가</td>
											<td class="f-lbl-sub" style="width:80px;border-top:0;border-right:0">금액</td>
										</tr>
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0" style="border-top:0">
							<tr>
								...
								<td style="width:80px;border-bottom:0;border-right:0">
	...
	<xsl:template match="//forminfo/subtables/subtable1/row">
		<tr class="sub_table_row">
            ...
            <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <select class="txtRead" name="TYPE">
                            <xsl:choose>
                            <xsl:when test="TYPE[.='무상쿠폰']">
                                    <option value="">물품선택</option>
                                   <option value="무상교재">무상교재</option>
                                    <option value="무상쿠폰" selected="true">무상쿠폰</option>
                                </xsl:when>
                                
                                <xsl:when test="TYPE[.='무상교재']">
                                    <option value="무상교재" selected="true">무상교재</option>
                                    <option value="무상쿠폰" >무상쿠폰</option>
                                                            
                                </xsl:when>
                            
                                <xsl:otherwise>
                                 <option value="" selected="true">물품선택</option>
                                    <option value="무상교재">무상교재</option>
                                    <option value="무상쿠폰">무상쿠폰</option>
