        ...
        <div class="m">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>
				  ...
				  <td class="f-lbl">UOM</td>
				  <td>
					  <xsl:choose>
						  <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
							  <input type="text" id="__mainfield" name="UOM" style="width:89px" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/UOM}" />
						  ...
						  <xsl:otherwise>
							  <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/UOM))" />&nbsp;
						  </xsl:otherwise>
					  </xsl:choose>
				  </td>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                      <input type="text" id="__mainfield" name="EXCHANGERATE" style="width:83%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/EXCHANGERATE}" />
              ...
              <tr>
                <td class="f-lbl1">LT</td>
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                      <input type="text" id="__mainfield" name="TOTALLT" class="txtDollar5" maxlength="15" data-inputmask="number;10;5" value="{//forminfo/maintable/TOTALLT}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td class="f-lbl1">구매담당자</td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                      <!--<input type="text" id="__mainfield" name="BUYER" style="width:38%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/BUYER}" />
						...
						<input type="text" id="__mainfield" name="BUYER" class="txtText" maxlength="50" value="{//forminfo/maintable/BUYER}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <!--<td class="f-lbl1" style="">PO TYPE</td>
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
              ...
              <tr>
                ...
                <td class="f-lbl1" style="border-bottom:0">월기획수량</td>
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                ...
                <td class="f-lbl1" style="border-bottom:0">년기획수량</td>
                <td colspan="3" style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                      <input type="text" id="__mainfield" name="YEARCOUNT" class="txtDollar" readonly="readonly" maxlength="15" data-inputmask="number;10;5" style="width: 41%" value="{//forminfo/maintable/YEARCOUNT}" />
                    </xsl:when>
                    <xsl:otherwise>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td rowspan="7" class="f-lbl3" style="width:4%">제<br /><br />조<br /><br />원<br /><br />가</td>
                <td rowspan="2" class="f-lbl3" style="width:4%">재<br /><br />료<br /><br />비</td>
              ...
              <tr>
                <td rowspan="2" class="f-lbl3">노<br /><br />무<br /><br />비</td>
              ...
              <tr>
                <td class="f-lbl3" rowspan="2">경<br />비</td>
              ...
              <tr>
                <td rowspan="3" class="f-lbl3">판<br />관<br />비</td>
                <td class="f-lbl3">일<br />반</td>
              ...
              <!--<tr>
                <td colspan="2" rowspan="2" class="f-lbl2" style="border-bottom:0">기타</td>
                <td class="f-lbl2">거래조건</td>
