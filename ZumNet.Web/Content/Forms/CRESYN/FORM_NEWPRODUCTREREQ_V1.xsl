                  ...
                  <img alt="">
                    <xsl:attribute name="src">
                      <xsl:choose>
                        ...
                        <xsl:otherwise>/Storage/<xsl:value-of select="//config/@companycode" />/CI/<xsl:value-of select="//creatorinfo/corp/logo" /></xsl:otherwise>
                      </xsl:choose>
                    </xsl:attribute>
                  </img>
                </td>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="border-bottom:0;text-align:center" colspan="2" >
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="HOPEDATE" >
                        ...
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/HOPEDATE" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
