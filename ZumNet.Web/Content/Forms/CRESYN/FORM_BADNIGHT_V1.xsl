    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .fh h1 {font-size:17.0pt;letter-spacing:1pt}
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" style="border-top:0;height:350px">
              <tr>
                <td style="border-bottom:0;border-right:0;height:100px;vertical-align:top">
                  <span style="width:100%;text-align:left;font-size:18">
                    귀하는  <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/FROMDATE))" /> 부터
                    <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/TODATE))" /> 까지 야간근로(22시 이후) 및 휴일근로가 불가합니다. <br /><br />
                    <font color="red">
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/FROMDATE))" /> 부터 <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/TODATE))" /> 까지 회사는 귀하의 야간근로(22시 이후) 및 휴일근로를 승인하지 않습니다.
                    </font>
                  </span>
                </td>
              </tr>
