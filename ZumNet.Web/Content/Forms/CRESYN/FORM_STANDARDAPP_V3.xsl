      ...
      <body>
        <div class="m">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                <table class="ft" border="0" cellspacing="0" cellpadding="0" style="border-bottom:0">
                  <tr>
                    <td class="f-lbl" style="border-right:0;border-bottom:0">제정/개정/폐지 내용</td>
                  </tr>
                </table>
              </xsl:otherwise>
            </xsl:choose>
          ...
          <div class="fm-editor">
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no" src="/{$root}/EA/External/Editor_tagfree.aspx?doctype=STANDARDAPP.html"></iframe>
              </xsl:otherwise>
            </xsl:choose>
          </div>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td rowspan="2" class="f-lbl2" style="border-bottom:0">표준주관부서검토</td>
                <td class="f-lbl4" style="border-right:0">신청사항 적합성 검토</td>
              </tr>
              <tr>
                <td style="height:60px;border-right:0;border-bottom:0">
