                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td class="f-lbl-sub" style="border-top:0">표준번호</td>
                      <td class="f-lbl-sub" style="border-top:0">ITEM명</td>
                      <td class="f-lbl-sub" style="border-top:0">품번</td>
                      <td class="f-lbl-sub" style="border-top:0">페이지수</td>
                      <td class="f-lbl-sub" style="border-top:0">제/개정일</td>
    ...
    <tr class="sub_table_row">
      ...
      <td  style="border-bottom:0">
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(ITNAME))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td  style="border-bottom:0">
