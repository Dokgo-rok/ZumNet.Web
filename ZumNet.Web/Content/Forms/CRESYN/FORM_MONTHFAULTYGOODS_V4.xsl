    ...
    <html xmlns:v="urn:schemas-microsoft-com:vml">
      ...
      <body>
        <div class="m">
          ...
          <div class="fm">
            <span style="width:30%">3. 매출액/매입액 대비율</span>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" colspan="6" style="border-right:0">당월 작업불량 손실금액 비율 (A)</td>
              </tr>
              <tr>
                <td class="f-lbl">매입액</td>
                <td class="f-lbl">발생금액</td>
                <td class="f-lbl">매입액대비율</td>
                <td class="f-lbl">매출액</td>
                <td class="f-lbl">발생금액</td>
                <td class="f-lbl" style="border-right:0">매출액대비율</td>
              </tr>
              <tr>
                <td>
                  <xsl:choose>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="SALESSUM" class="txtDollar" value="{//forminfo/maintable/SALESSUM}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td>
                  <input type="text" id="R_OCCURSUMQ" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/OCCURSUMQ}" />
                </td>
                <td style="border-right:0">
                  <input type="text" id="__mainfield" name="RATE2" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/RATE2}" />
                </td>
              </tr>
              <tr>
                <td class="f-lbl" colspan="3">당월 불용재고 발생금액 비율 (B)</td>
                <td class="f-lbl" colspan="3" style="border-right:0">당월 총 불용재고+작업불량 손실금액 비율 (A + B)</td>
              </tr>
              <tr>
                <td class="f-lbl">매출액</td>
                <td class="f-lbl">당월 발생금액</td>
                <td class="f-lbl">비율</td>
                <td class="f-lbl">매출액</td>
                <td class="f-lbl">당월 총발생금액</td>
                <td class="f-lbl" style="border-right:0">비율</td>
              </tr>
              <tr>
                <td style="border-bottom:0">
                  <input type="text" id="R_SALESSUM" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/SALESSUM}" />
                </td>
                <td style="border-bottom:0">
                  <input type="text" id="__mainfield" name="OCCURSUMW" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/OCCURSUMW}" />
                </td>
                <td style="border-bottom:0">
                  <input type="text" id="__mainfield" name="RATE3" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/RATE3}" />
                </td>
                <td style="border-bottom:0">
                  <input type="text" id="R_SALESSUM2" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/SALESSUM}" />
                </td>
                <td style="border-bottom:0">
                  <input type="text" id="__mainfield" name="OCCURSUMWQ" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/OCCURSUMWQ}" />
                </td>
                <td style="border-bottom:0;border-right:0">
                  <input type="text" id="__mainfield" name="RATE4" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/RATE4}" />
                </td>
              </tr>
            </table>
          </div>
                  ...
                  <table id="__subtable1" class="ft-sub" header="2" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WRBSUM1" class="txtDollar" value="{//forminfo/maintable/WRBSUM1}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
          ...
          <div class="fm">
            <span style="width:30%">4-1-2 작업불량 공수</span>
            <span style="width:70%;text-align:right;padding-right:4px">
              임율&nbsp;:&nbsp;
              (&nbsp;<xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="WRBGONGSU2" class="txtDollar" maxlength="20" value="{//forminfo/maintable/WRBGONGSU2}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="WRBGONGSU3" class="txtDollar" maxlength="20" value="{//forminfo/maintable/WRBGONGSU3}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                  ...
                  <table id="__subtable2" class="ft-sub" header="2" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WARCNT1" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/WARCNT1}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WARCNT2" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/WARCNT2}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                  ...
                  <table id="__subtable3" class="ft-sub" header="2" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WASCNT1" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/WASCNT1}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WASCNT2" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/WASCNT2}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                  ...
                  <table id="__subtable4" class="ft-sub" header="2" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WAFCNT1" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/WAFCNT1}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="WAFCNT2" class="txtRead_Right" readonly="readonly" value="{//forminfo/maintable/WAFCNT2}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="COUNT13" class="txtCurrency" maxlength="20" value="{COUNT13}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="SUM12" class="txtDollar" maxlength="20" value="{SUM12}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
  ...
  <xsl:template match="//forminfo/subtables/subtable5/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="TOTAMOUNT" class="txtCurrency" maxlength="20" value="{TOTAMOUNT}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="FLAWAMOUNT" class="txtcurrency" maxlength="20" value="{FLAWAMOUNT}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="TOTFLAW" class="txtcurrency" maxlength="20" value="{TOTFLAW}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
