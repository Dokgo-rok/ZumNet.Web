			...
			<body>
				<div class="m">
							...
							<tr>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='consent' and @partid!=''  and @actrole!='__r' and @step!='0'], '__si_Consent', '3')"/>
											</td>
										</tr>
									</table>
								</td>
					...
					<div class="fm-editor">
						<xsl:choose>
							<xsl:when test="$mode='read'">
								<div name="WEBEDITOR" id="__mainfield" style="width:100%;height:100%;padding:5px 19px 5px 18px;position:relative">
