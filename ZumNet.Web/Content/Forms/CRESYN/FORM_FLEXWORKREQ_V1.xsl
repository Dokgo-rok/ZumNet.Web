    ...
    <html>
      ...
      <body>
        <div class="m">
          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:92px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[@bizrole='agree' and @partid!='' and @step!='0'], '__si_Agree', '4', '주관부서')"/>
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="fm">
            <span>
              3. 특기사항&nbsp;<font size="2">(전보배치일 경우 세부발령일을 기재)</font>
            </span>
          </div>
          <div class="ff" />
