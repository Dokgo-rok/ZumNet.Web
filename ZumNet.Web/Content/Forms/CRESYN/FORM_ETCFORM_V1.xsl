                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="2"  border="0" cellspacing="0" cellpadding="0">
					...
					<tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0;border-right:0" colspan="8">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="TYPE" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="style">width:200px</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/TYPE" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/TYPE))" />
                          </xsl:otherwise>
                        </xsl:choose>
                        평가점수</td>
                    </tr>
					<tr style="height:42px">
                      <td class="f-lbl-sub" style="">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON1" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON1" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON1))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub" style="">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON2" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON2" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON2))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub" style="">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON3" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON3" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON3))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub" style="">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON4" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON4" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON4))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub" >
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON5" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON5" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON5))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON6" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON6" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON6))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub" style="">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON7" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON7" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON7))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="f-lbl-sub" style="border-right:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="PERSON8" style="">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">20</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/PERSON8" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
                          ...
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/PERSON8))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                    </tr>
    ...
    <tr class="sub_table_row">
      ...
      <td  style="font-size:20px">
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(COMPETENCY))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
        ...
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <select name="STANDARD" style="font-size:20px;height:40px;width:96%">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(STANDARD),'LⅤ')">
                  <option value="LⅤ" selected="selected">LⅤ</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="LⅤ">LⅤ</option>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(STANDARD),'LⅣ')">
                  <option value="LⅣ" selected="selected">LⅣ</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="LⅣ">LⅣ</option>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(STANDARD),'LⅢ')">
                  <option value="LⅢ" selected="selected">LⅢ</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="LⅢ">LⅢ</option>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(STANDARD),'LⅡ')">
                  <option value="LⅡ" selected="selected">LⅡ</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="LⅡ">LⅡ</option>
                </xsl:otherwise>
              </xsl:choose>
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(STANDARD),'LⅠ')">
                  <option value="LⅠ" selected="selected">LⅠ</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="LⅠ">LⅠ</option>
                </xsl:otherwise>
              </xsl:choose>
            </select>
          </xsl:when>
        ...
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE1" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE1),'5')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE1),'4')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE1),'3')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE1),'2')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE1),'1')">
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE1))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE2" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE2),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE2),'4')">
                  <option value="4" selected="selected">4</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="4">4</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE2),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE2),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE2),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE2))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE3" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE3),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE3),'4')">
                  <option value="4" selected="selected">4</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="4">4</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE3),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE3),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE3),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE3))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE4" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE4),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'4')">
                  <option value="4" selected="selected">4</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="4">4</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE4),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE4),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE4),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE4))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE5" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE5),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE5),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE5),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE5),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE5))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE6" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE6),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE6),'4')">
                  <option value="4" selected="selected">4</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="4">4</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE6),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE6),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE6),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE6))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td style="text-align:center">
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE7" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE7),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE7),'4')">
                  <option value="4" selected="selected">4</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="4">4</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE7),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE7),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE7),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE7))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
        ...
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE8" class="custom-select" style="font-size:18px">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE8),'5')">
                  <option value="5" selected="selected">5</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="5">5</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE8),'4')">
                  <option value="4" selected="selected">4</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="4">4</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE8),'3')">
                  <option value="3" selected="selected">3</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="3">3</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE8),'2')">
                  <option value="2" selected="selected">2</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="2">2</option>
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE8),'1')">
                  <option value="1" selected="selected">1</option>
                </xsl:when>
                <xsl:otherwise>
                  <option value="1">1</option>
          ...
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(CHANGE8))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
    </tr>
