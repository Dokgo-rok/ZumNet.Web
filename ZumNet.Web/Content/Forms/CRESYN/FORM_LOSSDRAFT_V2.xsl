    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          /* 화면 넓이, 에디터 높이, 양식명크기 */
          .m {width:1000px} .m .fm-editor {height:450px;border:windowtext 0pt solid}
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="DESCRIPITON" style="height:60px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="DESCRIPITON" class="txaText" style="height:60px" onkeyup="parent.checkTextAreaLength(this, 1000)">
                            <xsl:value-of select="//forminfo/maintable/DESCRIPITON" />
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
