  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body>
                    ...
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        <select id="__mainfield" name="DOCCLASS" style="font-size:16pt;font-weight:bold">
                          ...
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DOCCLASS),'설비부품')">
                              <option value="설비부품" selected="selected">설비부품</option>
                            </xsl:when>
                            <xsl:otherwise>
                              <option value="설비부품">설비부품</option>
                            </xsl:otherwise>
                          </xsl:choose>
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DOCCLASS),'소모품')">
                              <option value="소모품" selected="selected">소모품</option>
                            </xsl:when>
                            <xsl:otherwise>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-right:0;border-bottom:0;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="Subject" name="__commonfield" class="txtText" maxlength="200" valu="{//docinfo/subject}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="REASON" class="txaText" height="40px" onkeyup="parent.checkTextAreaLength(this, 500)">
                            <xsl:value-of select="//forminfo/maintable/REASON" />
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="CORPORATION" style="height:40px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 500)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="CORPORATION" class="txaText" height="40px" onkeyup="parent.checkTextAreaLength(this, 500)">
                            <xsl:value-of select="//forminfo/maintable/CORPORATION" />
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
                          <div id="__mainfield" name="CORPORATION" style="height:40px">
                            <xsl:attribute name="class">txaRead</xsl:attribute>
            ...
            (
              <input type="checkbox" id="ckb31" name="ckbBUSINESSCHECK" value="유">
                <xsl:if test="$mode='new' or $mode='edit'">
                  <xsl:attribute name="onclick">parent.fnCheckYN('ckbBUSINESSCHECK', this, 'BUSINESSCHECK')</xsl:attribute>
                </xsl:if>
                <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/BUSINESSCHECK),'유')">
                  <xsl:attribute name="checked">true</xsl:attribute>
                </xsl:if>
                <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/BUSINESSCHECK),'유')">
                  <xsl:attribute name="disabled">disabled</xsl:attribute>
                </xsl:if>
              </input>
              <label for="ckb31">유</label>
            
              <input type="checkbox" id="ckb32" name="ckbBUSINESSCHECK" value="무">
                <xsl:if test="$mode='new' or $mode='edit'">
                  <xsl:attribute name="onclick">parent.fnCheckYN('ckbBUSINESSCHECK', this, 'BUSINESSCHECK')</xsl:attribute>
                </xsl:if>
                <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/BUSINESSCHECK),'무')">
                  <xsl:attribute name="checked">true</xsl:attribute>
                </xsl:if>
                <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/BUSINESSCHECK),'무')">
                  <xsl:attribute name="disabled">disabled</xsl:attribute>
                </xsl:if>
              </input>
              <label for="ckb32">무</label>)
            </span>            
          </div>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="BUSINESSPLAN" style="height:40px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 500)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                          <xsl:value-of select="//forminfo/maintable/BUSINESSPLAN" />
                        </xsl:if>
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="BUSINESSPLAN" class="txaText" height="40px" onkeyup="parent.checkTextAreaLength(this, 500)">
                            <xsl:value-of select="//forminfo/maintable/BUSINESSPLAN" />
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
                          <div id="__mainfield" name="BUSINESSPLAN" style="height:40px">
                            <xsl:attribute name="class">txaRead</xsl:attribute>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/BUSINESSPLAN))" />
                          </div>
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:40px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0">부품/소모품명</td>
                      ...
                      <td class="f-lbl-sub" style="border-top:0">
                        ...
                        <xsl:otherwise>
                          ...
                          <xsl:choose>
                            <xsl:when test="$submode='revise'">
                              <input type="text" id="__mainfield" name="VATRATE" class="txtText" style="width:40px"  value="{//forminfo/maintable/VATRATE}" />
                            </xsl:when>
                            <xsl:otherwise>
                      ...
                      <td class="f-lbl-sub" style="border-top:0">적용설비명</td>
                      <td class="f-lbl-sub" style="border-top:0">모델명</td>
                      <td class="f-lbl-sub" style="border-top:0">구매사유</td>
                      ...
                      <td style="">
                        <xsl:choose>
                          ...
                          <xsl:otherwise>
                            ...
                            <xsl:choose>
                              <xsl:when test="$submode='revise'">
                                <input type="text" id="__mainfield" name="TOTALSUM" readonly="readonly" class="txtRead_Right" value="{//forminfo/maintable/TOTALSUM}" />
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:attribute name="class">tdRead_Right</xsl:attribute>
                      ...
                      <td style="">
                        <xsl:choose>
                          ...
                          <xsl:otherwise>
                            ...
                            <xsl:choose>
                              <xsl:when test="$submode='revise'">
                                <input type="text" id="__mainfield" name="TOTALTAX" readonly="readonly" class="txtRead_Right" value="{//forminfo/maintable/TOTALTAX}" />
                              </xsl:when>
                              <xsl:otherwise>
                                <xsl:attribute name="class">tdRead_Right</xsl:attribute>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="SCHEDULE" style="height:40px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 500)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="SCHEDULE" class="txaText" height="40px" onkeyup="parent.checkTextAreaLength(this, 500)">
                            <xsl:value-of select="//forminfo/maintable/SCHEDULE" />
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
                          <div id="__mainfield" name="SCHEDULE" style="height:40px">
                            <xsl:attribute name="class">txaRead</xsl:attribute>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="DESCRIPTION" class="txaText" height="60px" onkeyup="parent.checkTextAreaLength(this, 1000)">
                            <xsl:value-of select="//forminfo/maintable/DESCRIPTION" />
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
        ...
        <!-- 양식 메인 히든 필드 -->
        <input type="hidden" id="__mainfield" name="BUSINESSCHECK" value="{//forminfo/maintable/BUSINESSCHECK}" />          
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="STANDARD" class="txtText" maxlength="50" value="{STANDARD}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
              <xsl:attribute name="id">___editable</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="COUNT" class="txtDollar" maxlength="50" value="{COUNT}" />
              </xsl:when>
              <xsl:otherwise>
                <xsl:attribute name="class">tdRead_Center</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="UNIT" class="txtText" maxlength="10" value="{UNIT}" />
              </xsl:when>
              <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="UNITCOST1" class="txtDollar" maxlength="10" value="{UNITCOST1}" />
              </xsl:when>
              <xsl:otherwise>
                <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="SUM" class="txtRead_Right" value="{SUM}" />
              </xsl:when>
              <xsl:otherwise>
                <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(EQUIPMENT))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
