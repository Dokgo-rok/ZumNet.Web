        ...
        <div class="m">
          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="width:95px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='normal' and @partid!='' and @step!='0'], '__si_Normal', '1', '요청부서')"/>
                </td>
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                <table class="ft" border="0" cellspacing="0" cellpadding="0" style="border-bottom:0">
                  <tr>
                    <td class="f-lbl" style="border-right:0;border-bottom:0">요청내용</td>
                  </tr>
                </table>
              </xsl:otherwise>
            </xsl:choose>
