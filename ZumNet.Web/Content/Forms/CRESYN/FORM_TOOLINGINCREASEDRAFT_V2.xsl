        ...
        <table class="ft-sub-sub" header="0" border="0" cellpadding="0" cellspacing="0">
              ...
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="CLSNM">
                    <xsl:attribute name="class">txtRead</xsl:attribute>
                    <xsl:attribute name="readonly">readonly</xsl:attribute>
                    <xsl:attribute name="value"><xsl:value-of select="CLSNM" /></xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="MODELNO">
                    <xsl:attribute name="class">txtRead</xsl:attribute>
                    <xsl:attribute name="readonly">readonly</xsl:attribute>
                    <xsl:attribute name="value"><xsl:value-of select="MODELNO" /></xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:choose>
          ...
          <tr class="subsub_table_row">
            ...
            <td>
             <xsl:choose>
              <xsl:when test="$mode='new' or $mode='edit'">
                <input type="text" name="POSTYPE">
                  <xsl:attribute name="class">txtRead</xsl:attribute>
                  <xsl:attribute name="readonly">readonly</xsl:attribute>
                  <xsl:attribute name="value"><xsl:value-of select="POSTYPE" /></xsl:attribute>
                </input>
              </xsl:when>
              <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="CAVITY">
                    ...
                    <xsl:attribute name="value"><xsl:value-of select="CAVITY" /></xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
          ...
          <tr class="subsub_table_row">
            <td class="f-lbl-sub" style="border-bottom:0">제작처</td>
            <td style="border-bottom:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
            ...
            <td class="f-lbl-sub" style="border-bottom:0">소유처</td>
            <td style="border-right:0;border-bottom:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
