          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="f-lbl1" style="">적용모델명</td>
                <td style="width:23%;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="MODELNAME" class="txtText_u" readonly="readonly" style="width:80%" value="{//forminfo/maintable/MODELNAME}" />
                ...
                <td style="width:23%;border-right:0;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="APPLICANTDEPT" class="txtRead" style="width:50%"  readonly="readonly" value="{//forminfo/maintable/APPLICANTDEPT}" />.
                      <input type="text" id="__mainfield" name="APPLICANT" class="txtRead" style="width:30%"  readonly="readonly" value="{//forminfo/maintable/APPLICANT}" />
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                ...
                <td style="width:24%;border-bottom:0;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                ...
                <td style="border-bottom:0;width:23%;">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="APPLYDATE" class="txtDate" style="width:120px" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" value="{//forminfo/maintable/APPLYDATE}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-right:0;border-bottom:0;width:%">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ORGCODE" style="width:80%" tabindex="2" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/ORGCODE}" />
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="ITEMNO" style="width:85%">
      ...
      <td style="text-align:center">        
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="TOOLINGTYPE" class="txtText_u" readonly="readonly" value="{TOOLINGTYPE}" style="width:80%"/>
            <button onclick="parent.fnOption('external.toolingmakingreq',300,240,250,-40,'etc',this);" onfocus="this.blur()" class="btn_bg" style="height:16px;">
