    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .m .ft .f-option {width:18%} .m .ft .f-option1 {width:20%;}
      ...
      <body>
        <div class="m">
          <div class="fh">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="fh-m" style="font-size:25px">                  
                    한계돌파 혁신 아이디어 제안서                  
                </td>
                <td class="fh-r">&nbsp;</td>
              </tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="width:105px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='normal' and @partid!='' and @step!='0'], '__si_Normal', '1', '제안부서')"/>
                </td>
                <td style="font-size:1px">&nbsp;</td>
                <td style="width:95px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[@bizrole='1차심의' and @parent='' and @viewstate!='0' and @partid!='' and @step!='0'], '__si_OnlyOne', '1', '1 차심의자')"/>
                </td>
                <td style="font-size:1px;width:50px">&nbsp;</td>
                <td style="width:95px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[@bizrole='2차심의' and @parent=''  and @viewstate!='0'  and @partid!='' and @step!='0'], '__si_OnlyOne', '1', '2 차심의자')"/>
                </td>
              </tr>
            </table>
          </div>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="text-align:left;border-right:0;width:75%">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="SUGGESTNAME" class="txtText" maxlength="200"  value="{//forminfo/maintable/SUGGESTNAME}" />
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="SUGGESTREASON" class="txaText" style="height:55px" onclick="parent.checkTextAreaLength(this, 1000)" >
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no">
                  <xsl:attribute name="src">
                    /<xsl:value-of select="$root" />/EA/External/Editor_tagfree.aspx?doctype=SUGGESTPAPER_1.html
                  </xsl:attribute>
                </iframe>
              </xsl:otherwise>
            </xsl:choose>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="GETFFECT" class="txtText" maxlength="200" value="{//forminfo/maintable/GETFFECT}" />
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="STANDFFECT" class="txtText" maxlength="200" value="{//forminfo/maintable/STANDFFECT}" />
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="USEFFECT" class="txtText" maxlength="200" value="{//forminfo/maintable/USEFFECT}" />
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <td colspan="2" style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="NONFFECT" class="txaText" style="height:65px" onclick="parent.checkTextAreaLength(this, 1000)" >
                            <xsl:if test="$submode='revise'">
                              <xsl:value-of select="//forminfo/maintable/NONFFECT" />
                            </xsl:if>
                          </textarea>
            ...
            <table id="__si_Form"  class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="border-right:0;width:82%" colspan="5">
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb15" name="ckbREGICHECK" value="D1">
                      <xsl:choose>
                        <xsl:when test="$bizrole='1차심의' and $partid!='' ">
                          <xsl:attribute name="onclick">parent.fnCheckYN('ckbREGICHECK', this, 'REGICHECK')</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:if test="phxsl:isDiff(string(//forminfo/maintable/REGICHECK),'D1')">
                            <xsl:attribute name="disabled">disabled</xsl:attribute>
                          </xsl:if>
                        </xsl:otherwise>
                      </xsl:choose>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/REGICHECK),'D1')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb15">D</label>
                  </span>
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0;height:60px">등급부여사유</td>
                <td style="border-bottom:0;border-right:0" colspan="5">
                  ...
                  <xsl:choose>
                    <xsl:when test="$bizrole='1차심의' and $partid!=''">
                      <textarea id="__mainfield" name="AUDITREASON" style="height:55px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                    ...
                    <xsl:otherwise>
                      <div id="__mainfield" name="AUDITREASON" style="">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/AUDITREASON))" />
                      </div>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
            ...
            <table id="__si_Form"  class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="border-right:0;width:82%" colspan="5">
                  ...
                  <span class="f-option">
                    <input type="checkbox" id="ckb25" name="ckbREGICHECK2" value="D">
                      <xsl:choose>
                        <xsl:when test="$bizrole='2차심의' and $partid!='' ">
                          <xsl:attribute name="onclick">parent.fnCheckYN('ckbREGICHECK2', this, 'REGICHECK2')</xsl:attribute>
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:if test="phxsl:isDiff(string(//forminfo/maintable/REGICHECK2),'D')">
                            <xsl:attribute name="disabled">disabled</xsl:attribute>
                          </xsl:if>
                        </xsl:otherwise>
                      </xsl:choose>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/REGICHECK2),'D')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb25">D</label>
                  </span>
              ...
              <tr>
                <td class="f-lbl4" style="border-bottom:0;height:60px">등급부여사유</td>
                <td style="border-bottom:0;border-right:0" colspan="5">
                  <xsl:choose>
                    <xsl:when test="$bizrole='2차심의' and $partid!='' ">
                      <input type="text" id="__mainfield" name="AUDITREASON2" style="height:55px">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="maxlength">200</xsl:attribute>
                        <xsl:attribute name="value">
          ...
          <!--<div class="fm" id="panDisplay">
            <xsl:choose>
              <xsl:when test="((phxsl:isEqual(string(//forminfo/maintable/REGICHECK), 'S1') or phxsl:isEqual(string(//forminfo/maintable/REGICHECK), 'A1') or phxsl:isEqual(string(//forminfo/maintable/REGICHECK), 'B1')) and phxsl:isEqual(string(//forminfo/maintable/REGICHECK2), '')) or (phxsl:isEqual(string(//forminfo/maintable/REGICHECK2), 'A') or phxsl:isEqual(string(//forminfo/maintable/REGICHECK2), 'B') or phxsl:isEqual(string(//forminfo/maintable/REGICHECK2), 'S'))">
            ...
            <table id="__subtable2" class="ft" header="1" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="f-lbl4" style="width:18%;border-bottom:0">실행일정</td>
                <td style="width:32%;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="($bizrole='1차심의' or $bizrole='2차심의') and $partid!=''  ">
                      <input type="text" id="__mainfield" name="REALDATE">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="maxlength">200</xsl:attribute>
                        <xsl:attribute name="value">
                    ...
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/REALDATE))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                <td class="f-lbl4" style="width:18%;border-bottom:0">실행담당자</td>
                <td style="width:32%;border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="($bizrole='1차심의' or $bizrole='2차심의') and $partid!=''  ">
