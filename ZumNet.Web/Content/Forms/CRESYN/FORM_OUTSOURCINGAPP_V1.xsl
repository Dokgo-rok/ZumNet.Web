		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .ft .f-lbl1 {width:80px;text-align:center}
				...
				<div class="fb">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td rowspan="7" class="f-lbl" >외주<br/>신청내역</td>
							...
							<tr>
								<td class="f-lbl"><br/>외주내용<br/>&nbsp;<br/>상세기록<br/><br/></td>
							...
							<tr>
								<td class="f-lbl">자격요건</td>
								<td style="border-right:0">
									<input type="text" name="RIGHTFORM" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">64</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">64</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/RIGHTFORM" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl">외주업체추천</td>
								<td style="border-right:0">
									<input type="text" name="OUTRECOM" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">64</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">64</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/OUTRECOM" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl"> 업체추천담당자</td>
								<td style="border-right:0">
									<input type="text" name="OUTRECOMUSER" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">64</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">64</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/OUTRECOMUSER" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl">
									<strong>협 조 확 인</strong>
								</td>
								<td style="border-right:0;height:45px">
									<strong>
										외주 내역이 DB(선도데이타), 디자인(디자인팀), 3D(선도GIS연구소)의 경우에는 필히 해당 소속의 협조를
										득한 후 결재를 요청하시기 바랍니다.&nbsp;
									</strong>
								</td>
							</tr>
							<tr>
								<td colspan="3" style="border-bottom:0;border-right:0">* 첨부 : 실행예산 품의서 1부 </td>
							</tr>
						</table>
					</div>
