    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          /* 화면 넓이, 에디터 높이, 양식명크기 */
          .m {width:700px} .m .fm-editor {height:350px;border:windowtext 0pt solid}
          ...
          /* 인쇄 설정 : 맨하단으로 */
          @media print {.m .fm-editor {height:350px} #panStatement, #panHandover, #panCheckout {page-break-before:always}, .m .l_pos {display:block} , .m .l_pos2 {display:none}}
        </style>
      </head>
      <body>
        <div class="m">
                    ...
                    <div class="fm-editor">
                      <xsl:choose>
                        ...
                        <xsl:otherwise>
                          ...
                          <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no" src="/{$root}/EA/External/Editor_tagfree.aspx?doctype=RESIGNATION.html"></iframe>
                        </xsl:otherwise>
                      </xsl:choose>
                    </div>
                  </td>
