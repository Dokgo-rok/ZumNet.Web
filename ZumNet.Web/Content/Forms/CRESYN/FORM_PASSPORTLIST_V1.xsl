    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .m .ft .f-lbl {width:10%} .m .ft .f-lbl1 {width:2%} .m .ft .f-lbl2 {width:12%} .m .ft .f-lbl3 {width:5%}
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="text-align:center">중국상용복수<br></br>
                  1년유효 30일 체류
              </td>
                <td style="text-align:center">여권(10개월이상 유효),여권용사진1매,<br></br>
                ...
                <td style="text-align:center;border-right:0">중국취업비자의 경우 중국 법인에<br></br>
                  초청장 및 취업허가서 요청 必
                </td>
              </tr>
              <tr> 
                ...
                <td style="text-align:center">여권(6개월이상 유효),여권용사진2매,<br></br>
                  명함1장,신분증 앞/뒤 사본
              </td>
                <td style="text-align:center">6일+(1일)</td>
              ...
              <tr>
                <td style="text-align:center;height:50px">
                  <span class="f-option">
                    <input type="checkbox" id="ckb51" name="ckbVJCHECK" value="베트남일본">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVJCHECK', this, 'VJCHECK')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VJCHECK),'베트남일본')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VJCHECK),'베트남일본')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                  </span>
                </td>
                <td style="text-align:center">베트남/일본</td>
                <td style="text-align:center">무비자로 출장진행 가능<br></br>
                  (베트남 15일 체류가능,일본 3개월 체류가능)
              </td>
                <td style="text-align:center">X</td>
                <td style="text-align:center">X</td>
                <td style="text-align:center;border-right:0">X</td>
              </tr>
              <tr>
                <td style="text-align:center;height:50px">
                  <span class="f-option">
                    <input type="checkbox" id="ckb51" name="ckbAMCHECK" value="미국체크">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbAMCHECK', this, 'AMCHECK')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/AMCHECK),'미국체크')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/AMCHECK),'미국체크')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                  </span>
                </td>
                <td style="text-align:center">미국(유효기간 2年)<br></br>
                  90일 체류
              </td>
                <td style="text-align:center">전자여권</td>
              ...
              <tr>
                <td style="text-align:center;height:50px">
                  <span class="f-option">
                    <input type="checkbox" id="ckb51" name="ckbPACHECK" value="여권">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbPACHECK', this, 'PACHECK')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/PACHECK),'여권')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/PACHECK),'여권')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                  </span>
                </td>
                <td style="text-align:center">여권</td>
                <td style="text-align:center">여권발급신청서,여권용사진2매,신분증</td>
                <td style="text-align:center">4일</td>
                <td style="text-align:center;border-bottom:0" rowspan="2">신청자 본인 직접신청<br></br>(구청or시청)</td>
                <td style="text-align:center;border-right:0;border-bottom:0" rowspan="2">담당자 제량에 따라<br></br>
                  일정 조율가능 
              </td>                
              </tr>
              <tr>
                <td style="text-align:center;height:50px;border-bottom:0">
                  <span class="f-option">
                    <input type="checkbox" id="ckb61" name="ckbVICHECK" value="사증추가">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVICHECK', this, 'VICHECK')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VICHECK),'사증추가')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VICHECK),'사증추가')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                  </span>
                </td>
                <td style="text-align:center;border-bottom:0">사증추가</td>
                <td style="text-align:center;border-bottom:0">여권기재사항 변경 등 신청서, 여권</td>
                <td style="text-align:center;border-bottom:0">당일~1일</td>
              </tr>
