    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          /* 화면 넓이, 에디터 높이, 양식명크기 */
          .m {width:1000px} .m .fm-editor {height:450px;border:windowtext 1pt solid}
          ...
          .m .ft .f-option {width:15%} .m .ft .f-option1 {width:50px} .m .ft .f-option2 {width:70px}
        ...
        <div class="m">
                ...
                <table class="ft" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="border-right:0;border-bottom:0">
                      <textarea id="__mainfield" name="CONOPINIONS" style="height:60px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 2000)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                          <xsl:value-of select="//forminfo/maintable/CONOPINIONS" />
                        </xsl:if>
                      </textarea>
                    </td>
                  </tr>
              ...
              <div class="fm">
                <table class="ft" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="border-right:0;border-bottom:0">
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/CONOPINIONS))" />
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
                ...
                <td colspan="3">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="LOSSCLASS" class="txtText" maxlength="100" value="{//forminfo/maintable/LOSSCLASS}" >                     
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="LOSSCLASS" class="txtText" maxlength="200" value="{//forminfo/maintable/LOSSCLASS}" />
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/LOSSCLASS))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>                    
                </td>
                <td class="f-lbl">손실분류CODE</td>
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="LOSSCODE" style="width:80%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/LOSSCODE}" />
                      <button onclick="parent.fnOption('external.losscode',332,260,172,182,'','LOSSCODE');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="LOSSCODE" class="txtText_u" style="width:80%"  readonly="readonly" value="{//forminfo/maintable/LOSSCODE}" />
                          <button onclick="parent.fnOption('external.losscode',332,260,172,182,'','LOSSCODE');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                            <img alt="" class="blt01" style="margin:0 0 2px 0">
                              <xsl:attribute name="src">
                                /<xsl:value-of select="$root"/>/EA/Images/ico_28.gif
                        ...
                        <xsl:otherwise>
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/LOSSCODE))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>                    
              ...
              <tr>
                <td class="f-lbl">발생일시</td>
                <td style="width:15%">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="LOSSDATE" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" value="{//forminfo/maintable/LOSSDATE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:if test="$mlvl='A' or $mlvl='B'">
                        <xsl:attribute name="id">___editable</xsl:attribute>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="LOSSDATE" class="txtDate" maxlength="8" value="{//forminfo/maintable/LOSSDATE}" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)"/>
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/LOSSDATE))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                <td class="f-lbl">문서접수일</td>
                <td style="width:15%">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="RECEIVEDDATE">
                        ...
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/RECEIVEDDATE" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="RECEIVEDDATE" class="txtDate" maxlength="8" value="{//forminfo/maintable/RECEIVEDDATE}" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)"/>
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/RECEIVEDDATE))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>
                ...
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="AMOUNT" style="width:150px">
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="AMOUNT" class="txtDollar" style="width:150px" maxlength="20"  value="{//forminfo/maintable/AMOUNT}" />
                        </xsl:when>
                        <xsl:otherwise>
                          <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/AMOUNT))" />
                        </xsl:otherwise>
                      </xsl:choose>
                    </xsl:otherwise>
                  </xsl:choose>&nbsp;(&nbsp;
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="CURRENCY" class="txtText_u" readonly="readonly" style="width:60px;height:16px" value="{//forminfo/maintable/CURRENCY}" />
                          <button onclick="parent.fnOption('iso.currency',160,140,60,60,'etc','CURRENCY');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                            <img alt="" class="blt01" style="margin:0 0 2px 0">
                              <xsl:attribute name="src">
                                /<xsl:value-of select="$root"/>/EA/Images/ico_28.gif
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0">발생내용</td>
                <td colspan="5"  style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    ...
                    <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <textarea id="__mainfield" name="CONTENTS" class="txaText" style="height:60px" onkeyup="parent.checkTextAreaLength(this, 2000)">                         
                          <xsl:value-of select="//forminfo/maintable/CONTENTS" />                      
                          </textarea>
                        </xsl:when>
                        <xsl:otherwise>
                          <div id="__mainfield" name="CONTENTS" style="height:60px">
              ...
              <tr>
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:25">
                      <td class="f-lbl-sub" style="width:20px;border-top:0">&nbsp;</td>
                      <td class="f-lbl-sub" style="border-top:0">발생사유</td>
                      <td class="f-lbl-sub" style="border-top:0">발생원인</td>
                      <td class="f-lbl-sub" style="border-top:0">귀책부서</td>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="REASON" class="txtText" maxlength="100" value="{REASON}" />
              </xsl:when>
              <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="CAUSE" class="txtText" maxlength="100" value="{CAUSE}" />
              </xsl:when>
              <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="FAULTDIVISION">
              <xsl:attribute name="class">txtText</xsl:attribute>
              <xsl:attribute name="maxlength">50</xsl:attribute>
              <xsl:attribute name="value">
                <xsl:value-of select="FAULTDIVISION" />
              </xsl:attribute>
            </input>
          </xsl:when>
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="FAULTDIVISION" class="txtText" maxlength="50" value="{FAULTDIVISION}" />
              </xsl:when>
              <xsl:otherwise>
                <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(FAULTDIVISION))" />
              </xsl:otherwise>
            </xsl:choose>
          </xsl:otherwise>
        </xsl:choose>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="METHOD" class="txtText" maxlength="100" value="{METHOD}" />
              </xsl:when>
              <xsl:otherwise>
