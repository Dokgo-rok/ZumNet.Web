			...
			<body>
				<div class="m">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="f-lbl">무상공급처</td>
								<td style="border-right:0;">
                                	<input type="text" name="SUPPLIER" id="__mainfield">
                                       <xsl:choose>
                                           ...
                                           <xsl:when test="$mode='edit'">
                                               ...
                                               <xsl:attribute name="maxlength">80</xsl:attribute>
                                               <xsl:attribute name="value">
                                                   <xsl:value-of select="//forminfo/maintable/SUPPLIER" />
                                               </xsl:attribute>
                                           </xsl:when>
                                           <xsl:otherwise>
                                               <xsl:attribute name="class">txtRead</xsl:attribute>
                            ...
                            <tr>
                                ...
                                <td style="border-right:0;">
                                <input type="text" name="DEPART" id="__mainfield">
                                       <xsl:choose>
                                           <xsl:when test="$mode='new'">
                                               <xsl:attribute name="class">txtText</xsl:attribute>
                                               <xsl:attribute name="maxlength">80</xsl:attribute>
                                           ...
                                           <xsl:when test="$mode='edit'">
                                               ...
                                               <xsl:attribute name="maxlength">80</xsl:attribute>
                                               <xsl:attribute name="value">
                                                   <xsl:value-of select="//forminfo/maintable/DEPART" />
                                               </xsl:attribute>
                                           </xsl:when>
                                           <xsl:otherwise>
                                               <xsl:attribute name="class">txtRead</xsl:attribute>
                            ...
                            <tr>
								...
								<td style="border-right:0;">
                                 <input type="text" name="PERSON" id="__mainfield">
                                   <xsl:choose>
                                       <xsl:when test="$mode='new'">
                                           <xsl:attribute name="class">txtText</xsl:attribute>
                                           <xsl:attribute name="maxlength">80</xsl:attribute>
                                       ...
                                       <xsl:when test="$mode='edit'">
                                           ...
                                           <xsl:attribute name="maxlength">80</xsl:attribute>
                                           <xsl:attribute name="value">
                                               <xsl:value-of select="//forminfo/maintable/PERSON" />
                                           </xsl:attribute>
                                       </xsl:when>
                                       <xsl:otherwise>
                                           <xsl:attribute name="class">txtRead</xsl:attribute>
                            ...
                            <tr>
								<td class="f-lbl" style="border-bottom:0;">연락처</td>
                                <td style="border-right:0;border-bottom:0;"><input type="text" name="CONTACT" id="__mainfield">
                                   <xsl:choose>
                                       <xsl:when test="$mode='new'">
                                           <xsl:attribute name="class">txtText</xsl:attribute>
                                           <xsl:attribute name="maxlength">80</xsl:attribute>
                                       ...
                                       <xsl:when test="$mode='edit'">
                                           ...
                                           <xsl:attribute name="maxlength">80</xsl:attribute>
                                           <xsl:attribute name="value">
                                               <xsl:value-of select="//forminfo/maintable/CONTACT" />
                                           </xsl:attribute>
                                       </xsl:when>
                                       <xsl:otherwise>
                                           <xsl:attribute name="class">txtRead</xsl:attribute>
								...
								<xsl:when test="$mode='new' or $mode='edit'">
									<tr>
										<td style="text-align:right">
											<span style="width:140px">(단위 : 원, VAT 별도)</span>
							...
							<tr>
								<td>
									<table id="__subtable1" class="ft-sub" header="2"  border="0" cellspacing="0" cellpadding="0">
                                    	<tr style="height:25">
											<td class="f-lbl-sub" style="width:20px;border-top:0" rowspan="2">순번</td>
                                            <td class="f-lbl-sub" style="width:300px;border-top:0" rowspan="2">강좌명</td>
                                            <td class="f-lbl-sub" style="width:160px;border-top:0" colspan="2">수강기간</td>
                                            <td class="f-lbl-sub" style="width:30px;;border-top:0" rowspan="2">교육<br />일수</td>
                                            <td class="f-lbl-sub" style="width:30px;border-top:0" rowspan="2">인원</td>
                                            <td class="f-lbl-sub" style="width:80px;border-top:0" rowspan="2">단가</td>
                                            <td class="f-lbl-sub" style="width:80px;border-top:0;border-right:0" rowspan="2">금액</td>
                                        </tr>
                                        <tr style="height:25">
                                            <td class="f-lbl-sub" style="width:80px">시작</td>
                                            <td class="f-lbl-sub" style="width:80px">종료</td>
                                        </tr>
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0" style="border-top:0" >
							<tr>
								<td class="f-lbl1" style="border-bottom:0"><strong>합 계</strong></td>
								<td style="width:151px;border-bottom:0;border-right:0">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td style="border-right:0;height:100px;vertical-align:top">
									<xsl:choose>
										<xsl:when test="$mode='read'">
