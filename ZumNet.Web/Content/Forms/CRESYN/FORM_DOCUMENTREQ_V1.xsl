    ...
    <html>
      ...
      <body>
        <div class="m">
          <div class="fh">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="fh-r">
                  <table class="ft" border="0" cellspacing="0" cellpadding="0" style="height:20px;border:0px solid red">
                    <tr>
                      <td style="width:50%;text-align:right;font-size:14px;border:0">증명 No.</td>
          ...
          <div class="fm">
            <span>아래와 같이 제증명 발급을 신청 의뢰하오니 재가 바랍니다.</span>
          </div>
          <div class="ff" />
          <div class="ff" />
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table class="ft1" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td style="width:80px;border:0">
                        ...
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT2" style="width:40px" class="txtNumberic" maxlength="3" data-inputmask="number;3;0" value="{//forminfo/maintable/COUNT2}" />
                          </xsl:when>
                          <xsl:otherwise>
                    ...
                    <tr>
                      ...
                      <td style="width:80px;border:0">
                        ...
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT3" style="width:40px" class="txtNumberic" maxlength="3" data-inputmask="number;3;0" value="{//forminfo/maintable/COUNT3}" />
                          </xsl:when>
                          <xsl:otherwise>
                    ...
                    <tr>
                      <td colspan="2" style="height:30px;border:0">
                        &nbsp;&nbsp;&nbsp;주소표시&nbsp;:&nbsp;
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="DOCADDRESS" style="width:430px">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">100</xsl:attribute>
                              <xsl:attribute name="value">
                                <xsl:value-of select="//forminfo/maintable/DOCADDRESS" />
                              </xsl:attribute>
                            </input>
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DOCADDRESS))" />
                          </xsl:otherwise>
                        </xsl:choose>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td style="width:80px;border:0">
                        ...
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT4" style="width:40px" class="txtNumberic" maxlength="3" data-inputmask="number;3;0" value="{//forminfo/maintable/COUNT4}" />
                          </xsl:when>
                          <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl">개인사항</td>
                <td colspan="5" style="padding:10px 50px 10px 20px;border-right:0">
                  <table class="ft1" border="0" cellspacing="0" cellpadding="0">
                    <!--<tr>
                      <td style="height:30px;border:0">1. 재직증명</td>
                      <td style="width:80px;border:0">
                        (&nbsp;
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT5" style="width:40px">
                    ...
                    <tr>
                      <td style="height:30px;border:0">1. 경력증명</td>
                      <td style="width:80px;border:0">
                        (&nbsp;
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT6" style="width:40px" class="txtNumberic" maxlength="3" data-inputmask="number;3;0" value="{//forminfo/maintable/COUNT6}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/COUNT6))" />
                          </xsl:otherwise>
                        </xsl:choose>&nbsp;통)
                      </td>
                    </tr>
                    <tr>
                      <td style="height:30px;border:0">2. 퇴직증명</td>
                      <td style="width:80px;border:0">
                        (&nbsp;
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT7" style="width:40px" class="txtNumberic" maxlength="3" data-inputmask="number;3;0" value="{//forminfo/maintable/COUNT7}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/COUNT7))" />
                          </xsl:otherwise>
                        </xsl:choose>&nbsp;통)
                      </td>
                    </tr>
                    <tr>
                      <td style="height:30px;border:0">
                        ...
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="ETC2" style="width:360px">
                              <xsl:attribute name="class">txtText</xsl:attribute>
                              <xsl:attribute name="maxlength">50</xsl:attribute>
                              <xsl:attribute name="value">
                      ...
                      <td style="width:80px;border:0">
                        ...
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="COUNT8" style="width:40px" class="txtNumberic" maxlength="3" data-inputmask="number;3;0" value="{//forminfo/maintable/COUNT8}" />
                          </xsl:when>
                          <xsl:otherwise>
                            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/COUNT8))" />
                          </xsl:otherwise>
                        </xsl:choose>&nbsp;통)
                      </td>
                    </tr>
              ...
              <tr>
                <td class="f-lbl" style="height:30px;">
                  성명
                ...
                <td class="f-lbl1" style="height:30px;">부서명</td>
                <td style="width:20%">
                  <xsl:choose>
                    <xsl:when test="$mode='new'">
                ...
                <td class="f-lbl" style="height:40px;">주민번호<br/>(앞 여섯 자리)</td>
                <td style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="JUMINNO" class="txtJuminDash" maxlength="6" data-inputmask="number-n;6;0" value="{//forminfo/maintable/JUMINNO}" />
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                <td class="f-lbl" style="height:30px;">현주소</td>
              ...
              <tr>
                <td class="f-lbl" style="height:30px;">용도</td>
                <td colspan="5" style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="USAGE">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="maxlength">100</xsl:attribute>
                        <xsl:attribute name="value">
              ...
              <tr>
                <td class="f-lbl" style="height:30px;border-bottom:0">제출처</td>
                <td colspan="3" style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="SUBMITTED">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="maxlength">50</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/SUBMITTED" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/SUBMITTED))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
                <td class="f-lbl1" style="border-bottom:0">처리시한</td>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DEADLINE" class="datepicker txtDate" maxlength="10" data-inputmask="date;yyyy-MM-dd" value="{//forminfo/maintable/DEADLINE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/DEADLINE))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="DESCRIPTION" style="height:120px" class="txaText bootstrap-maxlength" maxlength="1000">
