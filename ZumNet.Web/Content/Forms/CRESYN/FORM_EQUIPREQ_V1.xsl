							...
							<tr>
								...
								<td style="border-right:0;border-bottom:0">
									 <xsl:choose>
										...
										<xsl:otherwise>
											<select style="width:100" class="txtRead" name="DOCTITLE" id="__mainfield" onchange="parent.fnEquipEq(this.value)">
												<xsl:choose>
													<xsl:when test="//forminfo/maintable/DOCTITLE[.='']">
														<option value="개인신규" selected="true">개인신규</option>
														<option value="개인변경">개인변경</option>
                                                     
													</xsl:when>
													<xsl:when test="//forminfo/maintable/DOCTITLE[.='개인변경']">
                                                    	<option value="개인신규">개인신규</option>
														<option value="개인변경" selected="true">개인변경</option>
