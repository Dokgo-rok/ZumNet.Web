		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .fm p {font-size:15px;font-family:맑은 고딕;margin:0 0 2px 0}
					...
					.m .txtDate.m, .txtDateDot, .m .txtMonth, .m .txtHHmm, .m .txtHHmmss
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0" class="fbSign" >
										<tr>
                                            ...
                                            <td style="width:5px;font-size:1px">&nbsp;</td>

								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='receive' and @partid!='' and @actrole!='__r' and @step!='0'], '__si_Receive', '1')"/>
											</td>
										</tr>
									</table>
								</td>
					...
					<div class="fm1">
						<table class="ft" style="border:0" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<input type="text" name="ENFORCEMENTDATE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDateDot</xsl:attribute>
		...
		<table style="width:100%;" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="width:160px;">
					<img alt="">
						<xsl:attribute name="src">/Storage/<xsl:value-of select="//config/@companycode" />/CI/sundosoft_logo_large.jpg</xsl:attribute>
					</img>
				</td>
				<td>
					<p><h2>㈜선도소프트</h2></p>
					<p>Tel : 82-2-2025-6500</p>
					<p>Fax : 82-2-2025-6511</p>
					<p>(153-759) 서울시 금천구 가산동 426-5 월드메르디앙벤처센터 2차15층</p>
					<p>http://www.sundosoft.com</p>
				</td>
			</tr>
		</table>
	</xsl:template>
	<xsl:template name="SUNDODATA_INFO">
		<table style="width:100%;" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="width:160px;">
					<img alt="">
						<xsl:attribute name="src">/Storage/<xsl:value-of select="//config/@companycode" />/CI/sundodata_logo_large.jpg</xsl:attribute>
					</img>
				</td>
				<td>
					<p><h2>㈜선도데이타</h2></p>
					<p>Tel : 82-2-2025-6598</p>
					<p>Fax : 82-2-2025-6511</p>
					<p>(153-759) 서울시 금천구 가산동 426-5 월드메르디앙벤처센터 2차15층</p>
					<p></p>
				</td>
	...
	<xsl:template name="ESRIKOREA_INFO">
		<table style="width:100%;" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="width:160px;">
					<img alt="">
						<xsl:attribute name="src">/Storage/<xsl:value-of select="//config/@companycode" />/CI/esrikorea_logo_large.jpg</xsl:attribute>
					</img>
				</td>
				<td>
					<p><h2>주식회사 한국ESRI</h2></p>
					<p>Tel : 82-2-2025-6700</p>
					<p>Fax : 82-2-2025-6701</p>
					<p>(153-759) 서울시 금천구 가산동 426-5 월드메르디앙벤처센터 2차 1502호</p>
					<p></p>
				</td>
			</tr>
		</table>
