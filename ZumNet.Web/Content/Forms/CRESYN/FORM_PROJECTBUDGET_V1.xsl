		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .fm-editor {height:600px;vertical-align:top;border:windowtext 1.5pt solid;}
					...
					<div class="fb">
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td style="width:12%;font-size:1px">&nbsp;</td>
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="width:49%">
												<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='agree' and @partid!='' and @actrole='_approver'], '__si_Agree', '1')"/>
											</td>
											<td style="width:2%;font-size:1px">&nbsp;</td>
											<td>
												<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='application' and @partid!='' and @actrole='_manager'], '__si_Application', '1')"/>
											</td>
										</tr>
									</table>
								</td>
                   ...
                   <div class="ff" />                   
					<div class="fm">
						...
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <input type="text" name="ORDERNO" id="__mainfield">
                                   <xsl:choose>
									...
									<xsl:if test="$mode!='read'">
										<xsl:attribute name="onkeyup">parent.PROJECTNO_onkeyup('project', 'OEDERNAME', 'ORDERNO');</xsl:attribute>
									</xsl:if>
                                </input>
                            ...
                            <tr>
								<td class="f-lbl" style="border-bottom:0;">프로젝트명
                                </td>
								<td style="border-right:0;border-bottom:0;">
                                <input type="text" name="OEDERNAME" id="__mainfield">
                                   <xsl:choose>
                                       <xsl:when test="$mode='new'">
                                           <xsl:attribute name="class">txtText</xsl:attribute>
                                           <xsl:attribute name="maxlength">100</xsl:attribute>
                                       ...
                                       <xsl:when test="$mode='edit'">
                                           ...
                                           <xsl:attribute name="style">border:1px solid red</xsl:attribute>
                                           <xsl:attribute name="value">
                                               <xsl:value-of select="//forminfo/maintable/OEDERNAME" />
                                           </xsl:attribute>
                                       </xsl:when>
                                       <xsl:otherwise>
                                           <xsl:attribute name="class">txtRead</xsl:attribute>
          ...
          <div class="fm">
            <span>아래와 같이 본 Project를 실행하고자 하오니 재가하여 주시기 바랍니다.</span>
          </div>
