          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:14%;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new'">
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="PURPOSE" style="height:100px">
                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0">도서명</td>
                      <td class="f-lbl-sub" style="border-top:0">저자</td>
                      <td class="f-lbl-sub" style="border-top:0;">출판사</td>
                      ...
                      <td class="f-lbl-sub" style="border-top:0;">구입 신청 사유</td>
                    ...
                    <tr>
                      <td colspan="6" style="border-bottom:0;border-right:0;height:100px">
                        <span style="width:100%;padding-left:20px">
                          (참고)&nbsp;1. 신규구입 도서 자료는 등록과 함께 등록인 라벨을 부착하여야 한다.<br />
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 등록된 도서는 부서장이 보관, 관리 하여야 할 책임이 있다.
                        </span>
                      </td>
                    </tr>
                  </table>
    ...
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(TITLE))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(AUTHOR))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(PUBLISHER))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <!--<td>
