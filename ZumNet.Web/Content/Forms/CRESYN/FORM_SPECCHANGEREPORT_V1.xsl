          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="f-lbl" style="border-bottom:0">요청일정</td>
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no">
                  <xsl:attribute name="src">/<xsl:value-of select="$root" />/EA/External/Editor_tagfree.aspx?doctype=SPECCHANGEREPORT_1.html</xsl:attribute>
                </iframe>
              </xsl:otherwise>
            </xsl:choose>
          </div>
