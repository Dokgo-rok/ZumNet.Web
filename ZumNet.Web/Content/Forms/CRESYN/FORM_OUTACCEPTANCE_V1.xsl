		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .ft .f-lbl1 {width:150px;text-align:center}
					.m .ft .f-lbl2 {width:100px;text-align:center}
					.fb table, .fm table, .fm1 table, .fm2 table, .fm3 table, .fm4 table {width:100%;height:100%}
					.fm span {text-align:left}
			...
			<body>
				<div class="m">
					...
					<div class="fm">
						<span style="text-align:left;width:100%">1. 업무내역</span>
					</div>
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td rowspan="5" class="f-lbl" >계약내용</td>
							...
							<tr>
								<td rowspan="7" class="f-lbl"  style="border-bottom:0;">
									외주내역
								</td>
								<td class="f-lbl">업체명</td>
								<td style="border-right:0" colspan="3">
									<input type="text" name="ENTERPRISENAME" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/ENTERPRISENAME" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl">사업자등록번호</td>
								<td class="f-lbl1">
									<input type="text" name="REGISTRATIONNUM" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">64</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">64</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/REGISTRATIONNUM" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
								...
								<td class="f-lbl">용역기간</td>
								<td style="border-right:0;">
									<input type="text" name="OUTFROMDATE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:99px;</xsl:attribute>
												<xsl:attribute name="maxlength">64</xsl:attribute>
											</xsl:when>
											<xsl:when test="$mode='edit'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												...
												<xsl:attribute name="maxlength">64</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/OUTFROMDATE" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
									...
									<input type="text" name="OUTTODATE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:100px;</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">64</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/OUTTODATE" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
							...
							<tr>
								<td class="f-lbl" style="border-bottom:0;">대금청구건수</td>
								<td style="border-bottom:0;">
									<input type="text" name="DEMANDNUM" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">20</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/DEMANDNUM" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
								...
								<td class="f-lbl" style="border-bottom:0;">투입인력</td>
								<td style="border-right:0;border-bottom:0;">
									<input type="text" name="INSERTPER" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">20</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">20</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/INSERTPER" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
					...
					<div class="ff" />
					<div class="fm">
						<span style="text-align:left;width:100%">2. 검수확인서(* 최종검수시 하자보증보험증권 및 결과물을 반드시 제출하여야 함.)</span>
					</div>
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="60%" style="text-align:center">기본 체크리스트 내용</td>
								<td style="text-align:center;border-right:0;">결과</td>
							</tr>
							<tr>
								<td width="60%">산출물간의 일관성을 유지하고 있는가?</td>
								<td style="border-right:0">
									<input type="text" name="CHECKLIST1" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST1" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td width="60%">산출물의 충분성/완전성에 문제가 없는가?</td>
								<td style="border-right:0">
									<input type="text" name="CHECKLIST2" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST2" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td width="60%">요구사항 정의서 기준으로 누락된 내용이 없는가?</td>
								<td style="border-right:0">
									<input type="text" name="CHECKLIST3" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST3" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td width="60%">결정된 요구상항 변경도 반영되었는가?</td>
								<td style="border-right:0">
									<input type="text" name="CHECKLIST4" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST4" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td width="60%">계획된 활동이 수행되었는가?</td>
								<td style="border-right:0">
									<input type="text" name="CHECKLIST5" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST5" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td width="60%">시정조치 사항이 모두 완결되었는가?</td>
								<td style="border-right:0">
									<input type="text" name="CHECKLIST6" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST6" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td width="60%" style="border-bottom:0;">고객의 품질검토 결과가 모두 반영되었는가?</td>
								<td style="border-right:0;border-bottom:0;">
									<input type="text" name="CHECKLIST7" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">100</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">100</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CHECKLIST7" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
					...
					<div class="ff" />
					<div class="fm">
						<span style="text-align:left;width:100%">3. 추가체크사항</span>
					</div>
							...
							<tr>
								<td>
									<table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="width:0px;display:none;border-top:0;">순번</td>
											<td style="width:60%;text-align:center;border-top:0;">체크 리스트 내용</td>
											<td style="width:40%;text-align:center;border-top:0;border-right:0;">결과</td>
										</tr>
	...
	<xsl:template match="//forminfo/subtables/subtable1/row">
		<tr class="sub_table_row">
			...
			<td style="text-align:center;border-right:0;">
				<input type="text" name="ITEMREPLY">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtText</xsl:attribute>
							<xsl:attribute name="maxlength">100</xsl:attribute>
