      ...
      <body>
        <div class="m">
          ...
          <div class="fm-editor">
            <xsl:choose>
              <xsl:when test="$mode='read'">
                <div name="WEBEDITOR" id="__mainfield" style="width:100%;height:100%;padding:0px;position:relative">
                  <xsl:attribute name="class">txaRead</xsl:attribute>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no">
                  <xsl:attribute name="src">/<xsl:value-of select="$root" />/EA/External/Editor_tagfree.aspx?doctype=MINUTES_1.html</xsl:attribute>
                </iframe>
              </xsl:otherwise>
            </xsl:choose>
          </div>
