      ...
      <head>
        ...
        <style type="text/css">
          <xsl:value-of select="phxsl:baseStyle()" />
			/* 화면 넓이, 에디터 높이, 양식명크기 */
			.m {width:739px} .m .fm-editor {height:450px;min-height:450px;border:windowtext 0pt solid}
      ...
      <body>
        <div class="m">
          ...
          <div class="fm-editor">
            ...
            <xsl:choose>
              <xsl:when test="$mode='read'">
                <div name="WEBEDITOR" id="__mainfield" class="txaRead" style="width:100%;height:100%;padding:0;position:relative">
