                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:25">
                      ...
                      <td class="f-lbl-sub" style="border-top:0">Competency</td>                      
                      <td class="f-lbl-sub" style="border-top:0">Required</td>
                      <td class="f-lbl-sub" style="border-top:0;border-right:0">평가점수</td>
                    </tr>
        ...
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE" style="font-size:20px;height:60px;width:90px;text-align:center">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'5')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'3')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'2')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'1')">
