      ...
      <body>
        <div class="m">
          ...
          <div class="fh">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="fh-r" style="width:625px">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td style="width:170px">
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignRcvPart($root, //processinfo/signline/lines, 'receive', '__si_Receive', '2', '수신부서')"/>
                      </td>
						<td style="font-size:20px">&nbsp;</td>
						<td style="width:170px">
							<xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignRcvPart($root, //processinfo/signline/lines, 'application', '__si_Application_R', '2', '주관부서')"/>
						</td>
                    </tr>
                  </table>
                </td>
          ...
          <div class="fm">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="width:36.2%;vertical-align:top">
                  <table class="ft" border="0" cellspacing="0" cellpadding="0" style="height:140px">
                    ...
                    <tr>
                      ...
                      <td>
						...
						<td class="f-lbl2">Supplier 부서</td>
						<td style="border-right:0">
							<xsl:choose>
								<xsl:when test="$mode='new'">
									<input type="text" id="__mainfield" name="SUPPLIERDEPT" class="txtRead" readonly="readonly" value=""/>
								</xsl:when>
								<xsl:when test="$mode='edit'">
									<input type="text" id="__mainfield" name="SUPPLIERDEPT" class="txtRead" readonly="readonly" value="{//forminfo/maintable/SUPPLIERDEPT}"/>
								</xsl:when>
								<xsl:otherwise>
                    ...
                    <tr>
                      ...
                      <td>
                        <xsl:choose>
                          <xsl:when test="$mode='new'">
                            <input type="text" id="__mainfield" name="TRIPPERSONGRADE" class="txtRead" readonly="readonly" style="width: 35%" value="{//creatorinfo/grade}"/>.&nbsp;
							  <input type="text" id="__mainfield" name="TRIPPERSON" class="txtRead" readonly="readonly" style="width: 58%" value="{//creatorinfo/name}"/>
                          </xsl:when>
                          <xsl:when test="$mode='edit'">
                            <input type="text" id="__mainfield" name="TRIPPERSONGRADE" class="txtRead" readonly="readonly" style="width: 35%" value="{//forminfo/maintable/TRIPPERSONGRADE}"/>
							  <input type="text" id="__mainfield" name="TRIPPERSON" class="txtRead" readonly="readonly" style="width: 58%" value="{//forminfo/maintable/TRIPPERSON}"/>
                          </xsl:when>
                          <xsl:otherwise>
                      ...
                      <td class="f-lbl2">Supplier</td>
                      <td style="border-right:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new'">
                            <input type="text" id="__mainfield" name="SUPPLIER" class="txtRead" readonly="readonly" value=""/>
                          </xsl:when>
                          <xsl:when test="$mode='edit'">
                            <input type="text" id="__mainfield" name="SUPPLIER" class="txtRead" readonly="readonly" value="{//forminfo/maintable/SUPPLIER}"/>
                          </xsl:when>
                          <xsl:otherwise>
                      ...
                      <td>
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
                            <input type="text" id="__mainfield" name="LOCATION" style="width:87%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/LOCATION}" />
                    ...
                    <tr>
                      ...
                      <td class="f-lbl2">
						...
						<td class="f-lbl2" style="border-right:0">
							<xsl:choose>
								<xsl:when test="$mode='new' or $mode='edit'">
									<input type="text" id="__mainfield" name="CURRENCY9" class="txtText_u" readonly="readonly" style="width:76%;text-align:center">
										<xsl:attribute name="value">
											<xsl:choose>
												<xsl:when test="$mode='new'">PHP</xsl:when>
												<xsl:otherwise>
          ...
          <div class="fm">
			...
			<div class="fm">
				<table border="0" cellspacing="0" cellpadding="0">
						...
						<xsl:when test="$mode='new' or $mode='edit'">
							<tr>
								...
								<td class="fm-button">
									...
									<button type="button" class="btn icon-btn btn-outline-secondary btn-sm" data-toggle="tooltip" data-placement="bottom" title="삭제" onclick="_zw.form.removeRow('__subtable6');">
										<i class="fas fa-minus"></i>
									</button>-->
								</td>
							</tr>
					...
					<tr>
						<td colspan="2">
							<table id="__subtable6" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
								<xsl:if test="$mode='new' or $mode='edit'">
									<xsl:attribute name="style">table-layout:fixed</xsl:attribute>
								</xsl:if>
								<colgroup>
