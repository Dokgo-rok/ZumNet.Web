        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0">발명의 명칭</td>
          ...
          <!--<div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" style="border-right:0" colspan="2">합의권자 의견</td>
              </tr>

              <tr>
                <td style="border-bottom:0">인사총무팀</td>
                <td style="border-right:0;border-bottom:0">유지,소멸 예상비용</td>
              </tr>
            </table>
          </div>
          ...
          <div class="fm-editor">
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no" src="/{$root}/EA/External/Editor_tagfree.aspx?doctype=INDUSTRIALDRAFT_1.html"></iframe>
              </xsl:otherwise>
            </xsl:choose>
          </div>
