        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0">적용기간</td>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0" style="border-top:0;height:350px">
              <tr>
                <td style="border-bottom:0;border-right:0;height:100px;vertical-align:top">
                  <span style="width:100%;text-align:left;font-size:18">귀하는 근로기준법 제 53조 제 2항에 의거하여, <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/FROMDATE))" /> 부터 
                    <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/TODATE))" /> 까지 <br />시간외근로 및 휴일근로가 불가합니다. <br /><br /> 해당기간에는 소정근로시간 근무 후 즉시 업무 종료하시기 바랍니다. <br /><br />
                    <font color="red">    <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/FROMDATE))" /> 부터 <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/TODATE))" /> 까지 회사는 귀하의 시간외근로 및 휴일근로를 승인하지 않습니다. </font>
                  </span>
                </td>
              </tr>
              <tr>
                <td style="font-size:35;heigh:250px;text-align:center;vertical-align:center;border-bottom:0;border-right:0">
                  크레신 주식회사 귀하
                </td>
              </tr>
            </table>
