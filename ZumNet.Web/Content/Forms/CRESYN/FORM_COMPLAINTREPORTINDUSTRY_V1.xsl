            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="width:22%">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="CUSTOMER" style="width:99%">
                        <xsl:attribute name="class">txtText</xsl:attribute>
              ...
              <tr>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="LOTNO" style="width:99%">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="maxlength">30</xsl:attribute>
                        <xsl:attribute name="value">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="100%" marginheight="0" marginwidth="0" scrolling="no">
                  <xsl:attribute name="src">
                    /<xsl:value-of select="$root" />/EA/External/Editor_tagfree.aspx?doctype=COMPLAINTREPORT_1.html
                  </xsl:attribute>
                </iframe>
              </xsl:otherwise>
            </xsl:choose>
