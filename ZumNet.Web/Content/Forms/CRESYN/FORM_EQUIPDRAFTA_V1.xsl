                ...
                <xsl:otherwise>
                  <tr>
                    ...
                    <td class="fm-button">
                      ...
                      <xsl:choose>
                        <xsl:when test="$submode='revise'">
                          <input type="text" id="__mainfield" name="CURRENCY" style="width:60px;height:16px" readonly="readonly" class="txtText" value="{//forminfo/maintable/CURRENCY}" />
                          <button onclick="parent.fnOption('iso.currency',160,140,10,115,'etc','CURRENCY');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0">구입년월</td>
                      <td class="f-lbl-sub" style="border-top:0">수리내역</td>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          ...
                          <xsl:otherwise>
                            ...
                            <xsl:choose>
                              <xsl:when test="$submode='revise'">
                                <input type="text" id="__mainfield" name="UNITSUM1" class="txtRead_Right" readonly="readonly"  value="{//forminfo/maintable/UNITSUM1}" />
                              </xsl:when>
                              <xsl:otherwise>
                      ...
                      <td style="border-bottom:0">
                        <xsl:choose>
                          ...
                          <xsl:otherwise>
                            ...
                            <xsl:choose>
                              <xsl:when test="$submode='revise'">
                                <input type="text" id="__mainfield" name="UNITSUM2" class="txtRead_Right" readonly="readonly"   value="{//forminfo/maintable/UNITSUM2}" />
                              </xsl:when>
                              <xsl:otherwise>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="EQUIPMENT" class="txtText" maxlength="50" value="{EQUIPMENT}" />            
          </xsl:when>
          <xsl:otherwise>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
              <xsl:attribute name="id">___editable</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="MODELNAME" class="txtText" maxlength="50" value="{MODELNAME}" />              
          </xsl:when>
          <xsl:otherwise>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
              <xsl:attribute name="id">___editable</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="SERIALNUMBER" class="txtText" maxlength="20" value="{SERIALNUMBER}" />              
          </xsl:when>      
            <xsl:otherwise>
              <xsl:if test="$mlvl='A' or $mlvl='B'">
                <xsl:attribute name="id">___editable</xsl:attribute>
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(SERIALNUMBER))" />
                </xsl:otherwise>
              </xsl:choose>
            </xsl:otherwise>
          </xsl:choose>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="COUNT" class="txtVolume" maxlength="10" value="{COUNT}" />            
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Center</xsl:attribute>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="COUNT" class="txtVolume" maxlength="20" value="{COUNT}" />
              </xsl:when>
              <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="PURCHASEDATE" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" value="{PURCHASEDATE}" />            
          </xsl:when>
          <xsl:otherwise>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
              <xsl:attribute name="id">___editable</xsl:attribute>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="PURCHASEDATE" class="txtDate" maxlength="8"  value="{PURCHASEDATE}" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" />                
              </xsl:when>
              <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="COMMENT" class="txtText" maxlength="50" value="{COMMENT}" />            
          </xsl:when>
          <xsl:otherwise>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
              <xsl:attribute name="id">___editable</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="UNITCOST1" class="txtCurrency" maxlength="20" value="{UNITCOST1}" />            
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="UNITCOST2" class="txtCurrency" maxlength="20" value="{UNITCOST2}" />            
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
            <xsl:if test="$mlvl='A' or $mlvl='B'">
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="COMPANY" class="txtText" maxlength="50" value="{COMPANY}" />
              </xsl:when>
              <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              <xsl:when test="$submode='revise'">
                <input type="text" name="SETTLEMENT" class="txtText" maxlength="50" value="{SETTLEMENT}" />
              </xsl:when>
              <xsl:otherwise>
