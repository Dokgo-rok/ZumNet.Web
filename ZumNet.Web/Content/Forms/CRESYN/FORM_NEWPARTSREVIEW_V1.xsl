            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="RECDAY">
                        ...
                        <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/RECDAY" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
              ...
              <tr>
                ...
                <td colspan="3">
                  ...
                  <td style="border-right:0">
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        <input type="text" id="__mainfield" name="COUNT">
                          <xsl:attribute name="class">txtNumberic</xsl:attribute>
                          <xsl:attribute name="maxlength">20</xsl:attribute>
                          <xsl:attribute name="value">
                          <xsl:value-of select="//forminfo/maintable/COUNT" />
                        </xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
