		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .ft .f-lbl1 {width:15%;text-align:center}
					.m .ft .f-lbl2 {width:43%;text-align:center}
			...
			<body>
				<div class="m">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="f-lbl1">구&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;분</td>
								<td class="f-lbl2">선도소프트</td>
								<td class="f-lbl2" style="border-right:0;">외주용역내역</td>
							</tr>
							<tr>
								<td class="f-lbl1">계약명</td>
								<td>
									<input type="text" name="CONTRACTSUNDO" id="__mainfield">
										<xsl:choose>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">50</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTSUNDO" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
										...
										<xsl:if test="$mode!='read'">
											<xsl:attribute name="onkeyup">parent.PROJECTNO_onkeyup('project', 'CONTRACTSUNDO', 'PROJECTNOSUNDO');</xsl:attribute>
										</xsl:if>
									</input>
								</td>
								<td style="border-right:0;">
									<input type="text" name="CONTRACTOUT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">50</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">50</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTOUT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl1">프로젝트번호</td>
								<td>
									<input type="text" name="PROJECTNOSUNDO" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
                                                <xsl:attribute name="style">border:1px solid red</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">20</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/PROJECTNOSUNDO" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
								...
								<td style="border-right:0;">
									<input type="text" name="PROJECTNOOUT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">20</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">20</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/PROJECTNOOUT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl1">발주처명/외주업체명</td>
								<td>
									<input type="text" name="ORDERORGSUNDO" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">50</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">50</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/ORDERORGSUNDO" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
								...
								<td style="border-right:0;">
									<input type="text" name="ORDERORGOUT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtText</xsl:attribute>
												<xsl:attribute name="maxlength">50</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">50</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/ORDERORGOUT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead</xsl:attribute>
							...
							<tr>
								<td class="f-lbl1">계약금액</td>
								<td>
									<input type="text" name="CONTRACTPRICESUNDO" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">20</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTPRICESUNDO" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
								...
								<td style="border-right:0;">
									<input type="text" name="CONTRACTPRICEOUT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtCurrency</xsl:attribute>
												<xsl:attribute name="maxlength">20</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">20</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTPRICEOUT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Right</xsl:attribute>
							...
							<tr>
								<td class="f-lbl1" style="border-bottom:0;">계약기간</td>
								<td style="border-bottom:0;">
									<input type="text" name="CONTRACTSDATESUNDO" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:102px;</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTSDATESUNDO" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
									...
									<input type="text" name="CONTRACTEDATESUNDO" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:102px;</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTEDATESUNDO" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
								...
								<td style="border-right:0;border-bottom:0;">
									<input type="text" name="CONTRACTSDATEOUT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:102px;</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTSDATEOUT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
									...
									<input type="text" name="CONTRACTEDATEOUT" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtDate</xsl:attribute>
												<xsl:attribute name="style">width:102px;</xsl:attribute>
											...
											<xsl:when test="$mode='edit'">
												...
												<xsl:attribute name="maxlength">8</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/CONTRACTEDATEOUT" />
												</xsl:attribute>
											</xsl:when>
											<xsl:otherwise>
												<xsl:attribute name="class">txtRead_Center</xsl:attribute>
							...
							<tr>
								<td>
									<table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="width:15%;text-align:center;border-top:0;" rowspan="100">선도소프트</td>
											<td style="width:0px;display:none;border-top:0;"></td>
											<td style="width:16%;text-align:center;border-top:0;">비용구분</td>
											<td style="width:16%;text-align:center;border-top:0;">관리구분</td>
											<td style="width:16%;text-align:center;border-top:0;">입금일자</td>
											<td style="width:16%;text-align:center;border-top:0;">입금금액</td>
											<td style="width:;text-align:center;border-top:0;border-right:0;">비고</td>
										</tr>
					...
					<div class="fm">
						<table border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>
									<table id="__subtable2" class="ft-sub" style="border-bottom:0" header="1"  border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="width:15%;text-align:center;border-top:0;" rowspan="100">외주용역</td>
											<td style="width:0px;display:none;border-top:0;"></td>
											<td style="width:16%;text-align:center;border-top:0;">비용구분</td>
											<td style="width:16%;text-align:center;border-top:0;">관리구분</td>
											<td style="width:16%;text-align:center;border-top:0;">
												세금계산서<br />발행일자
											</td>
											<td style="width:16%;text-align:center;border-top:0;">지급금액</td>
											<td style="width:;text-align:center;border-top:0;border-right:0;">비고</td>
										</tr>
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="f-lbl3"  style="border-bottom:0">잔액</td>
								<td style="border-bottom:0;border-right:0">
									<input type="text" name="BALANCE" id="__mainfield">
										<xsl:choose>
											<xsl:when test="$mode='new'">
												<xsl:attribute name="class">txtCurrency</xsl:attribute>
												<xsl:attribute name="maxlength">20</xsl:attribute>
	...
	<xsl:template match="//forminfo/subtables/subtable1/row">
		<tr class="sub_table_row">
			...
			<td style="text-align:center;">
				<xsl:choose>
					<xsl:when test="$mode='read'">
						<input type="text" name="COSTTYPESUNDO">
							<xsl:attribute name="class">txtRead</xsl:attribute>
							<xsl:attribute name="readonly">readonly</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="COSTTYPESUNDO" />
							</xsl:attribute>
						</input>
					</xsl:when>
					<xsl:otherwise>
						<select class="txtRead" name="COSTTYPESUNDO">
							<xsl:choose>
								<xsl:when test="COSTTYPESUNDO[.='']">
									<option value="선급금" selected="true">선급금</option>
									<option value="기성금">기성금</option>
									<option value="준공금">준공금</option>
								</xsl:when>
								<xsl:when test="COSTTYPESUNDO[.='선급금']">
									<option value="선급금" selected="true">선급금</option>
									<option value="기성금">기성금</option>
									<option value="준공금">준공금</option>
								</xsl:when>
								<xsl:when test="COSTTYPESUNDO[.='기성금']">
									<option value="선급금">선급금</option>
									<option value="기성금" selected="true">기성금</option>
									<option value="준공금">준공금</option>
								</xsl:when>
								<xsl:when test="COSTTYPESUNDO[.='준공금']">
									<option value="선급금">선급금</option>
									<option value="기성금">기성금</option>
									<option value="준공금" selected="true">준공금</option>
								</xsl:when>
								<xsl:otherwise>
									<option value="선급금" selected="true">선급금</option>
									<option value="기성금">기성금</option>
			...
			<td style="text-align:center;">
				<xsl:choose>
					<xsl:when test="$mode='read'">
						<input type="text" name="MANAGERTYPESUNDO">
							<xsl:attribute name="class">txtRead</xsl:attribute>
							<xsl:attribute name="readonly">readonly</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="MANAGERTYPESUNDO" />
							</xsl:attribute>
						</input>
					</xsl:when>
					<xsl:otherwise>
						<select class="txtRead" name="MANAGERTYPESUNDO">
							<xsl:choose>
								<xsl:when test="MANAGERTYPESUNDO[.='']">
									<option value="개발용역비" selected="true">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPESUNDO[.='개발용역비']">
									<option value="개발용역비" selected="true">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPESUNDO[.='HW']">
									<option value="개발용역비">개발용역비</option>
									<option value="HW" selected="true">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPESUNDO[.='SW-ESRI']">
									<option value="개발용역비">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI" selected="true">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPESUNDO[.='SW-기타']">
									<option value="개발용역비">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타" selected="true">SW-기타</option>
								</xsl:when>
								<xsl:otherwise>
									<option value="개발용역비" selected="true">개발용역비</option>
									<option value="HW">HW</option>
			...
			<td style="text-align:center;">
				<input type="text" name="DEPOSITDATESUNDO">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtDate</xsl:attribute>
							<xsl:attribute name="maxlength">8</xsl:attribute>
						...
						<xsl:when test="$mode='edit'">
							...
							<xsl:attribute name="maxlength">8</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="DEPOSITDATESUNDO" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead_Center</xsl:attribute>
			...
			<td style="text-align:center;">
				<input type="text" name="DEPOSITAMOUNTSUNDO">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtCurrency</xsl:attribute>
							<xsl:attribute name="maxlength">20</xsl:attribute>
						...
						<xsl:when test="$mode='edit'">
							...
							<xsl:attribute name="maxlength">20</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="DEPOSITAMOUNTSUNDO" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead_Right</xsl:attribute>
			...
			<td style="text-align:center;border-right:0;">
				<input type="text" name="CONTENTSSUNDO">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtText</xsl:attribute>
							<xsl:attribute name="maxlength">50</xsl:attribute>
						...
						<xsl:when test="$mode='edit'">
							...
							<xsl:attribute name="maxlength">50</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="CONTENTSSUNDO" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
	...
	<xsl:template match="//forminfo/subtables/subtable2/row">
		<tr class="sub_table_row">
			...
			<td style="text-align:center;">
				<xsl:choose>
					<xsl:when test="$mode='read'">
						<input type="text" name="COSTTYPEOUT">
							<xsl:attribute name="class">txtRead</xsl:attribute>
							<xsl:attribute name="readonly">readonly</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="COSTTYPEOUT" />
							</xsl:attribute>
						</input>
					</xsl:when>
					<xsl:otherwise>
						<select class="txtRead" name="COSTTYPEOUT">
							<xsl:choose>
								<xsl:when test="COSTTYPEOUT[.='']">
									<option value="기지급액" selected="true">기지급액</option>
									<option value="지급금액">지급금액</option>
								</xsl:when>
								<xsl:when test="COSTTYPEOUT[.='기지급액']">
									<option value="기지급액" selected="true">기지급액</option>
									<option value="지급금액">지급금액</option>
								</xsl:when>
								
								<xsl:when test="COSTTYPEOUT[.='지급금액']">
									<option value="기지급액">기지급액</option>
									<option value="지급금액" selected="true">지급금액</option>
								</xsl:when>
								<xsl:otherwise>
									<option value="기지급액" selected="true">기지급액</option>
									<option value="지급금액">지급금액</option>
			...
			<td style="text-align:center;">
				<xsl:choose>
					<xsl:when test="$mode='read'">
						<input type="text" name="MANAGERTYPEOUT">
							<xsl:attribute name="class">txtRead</xsl:attribute>
							<xsl:attribute name="readonly">readonly</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="MANAGERTYPEOUT" />
							</xsl:attribute>
						</input>
					</xsl:when>
					<xsl:otherwise>
						<select class="txtRead" name="MANAGERTYPEOUT">
							<xsl:choose>
								<xsl:when test="MANAGERTYPEOUT[.='']">
									<option value="개발용역비" selected="true">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPEOUT[.='개발용역비']">
									<option value="개발용역비" selected="true">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPEOUT[.='HW']">
									<option value="개발용역비">개발용역비</option>
									<option value="HW" selected="true">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPEOUT[.='SW-ESRI']">
									<option value="개발용역비">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI" selected="true">SW-ESRI</option>
									<option value="SW-기타">SW-기타</option>
								</xsl:when>
								<xsl:when test="MANAGERTYPEOUT[.='SW-기타']">
									<option value="개발용역비">개발용역비</option>
									<option value="HW">HW</option>
									<option value="SW-ESRI">SW-ESRI</option>
									<option value="SW-기타" selected="true">SW-기타</option>
			...
			<td style="text-align:center;">
				<input type="text" name="DEPOSITDATEOUT">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtDate</xsl:attribute>
							<xsl:attribute name="maxlength">8</xsl:attribute>
						...
						<xsl:when test="$mode='edit'">
							...
							<xsl:attribute name="maxlength">8</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="DEPOSITDATEOUT" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
			...
			<td style="text-align:center;">
				<input type="text" name="DEPOSITAMOUNTOUT">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtCurrency</xsl:attribute>
							<xsl:attribute name="maxlength">20</xsl:attribute>
						...
						<xsl:when test="$mode='edit'">
							...
							<xsl:attribute name="maxlength">20</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="DEPOSITAMOUNTOUT" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead_Right</xsl:attribute>
			...
			<td style="text-align:center;border-right:0;">
				<input type="text" name="CONTENTSOUT">
					<xsl:choose>
						<xsl:when test="$mode='new'">
							<xsl:attribute name="class">txtText</xsl:attribute>
							<xsl:attribute name="maxlength">50</xsl:attribute>
						...
						<xsl:when test="$mode='edit'">
							...
							<xsl:attribute name="maxlength">50</xsl:attribute>
							<xsl:attribute name="value">
								<xsl:value-of select="CONTENTSOUT" />
							</xsl:attribute>
						</xsl:when>
						<xsl:otherwise>
							<xsl:attribute name="class">txtRead</xsl:attribute>
