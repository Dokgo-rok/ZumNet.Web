        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td class="f-lbl" style="border-bottom:0">개발주관부서</td>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DEPARTMENT" style="width:92%" class="txtText" readonly="readonly" value="{//forminfo/maintable/DEPARTMENT}" />
                    ...
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/DEPARTMENT))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="STOPREASON" style="height:200px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 2000);">
                        <xsl:value-of select="//forminfo/maintable/STOPREASON" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="STOPREASON" style="height:200px;padding:2px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/STOPREASON))" />
                      </div>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="f-lbl" style="border-bottom:0">
                  개발손실<br></br>비용처리<br></br>고객협의내용
                </td>
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="CONSULTATIONCONTENT" style="height:200px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 2000);">
                        <xsl:value-of select="//forminfo/maintable/CONSULTATIONCONTENT" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="CONSULTATIONCONTENT" style="height:200px;padding:2px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/CONSULTATIONCONTENT))" />
                      </div>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="COOPERATIONREQUEST" style="height:200px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 2000);">
                        <xsl:value-of select="//forminfo/maintable/COOPERATIONREQUEST" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="COOPERATIONREQUEST" style="height:200px;padding:2px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/COOPERATIONREQUEST))" />
                      </div>
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
