        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl">제&nbsp;출&nbsp;처</td>
                <td style="border-right:0" colspan="3">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="SUBMITPLACE" class="txtText" maxlength="100" value="{//forminfo/maintable/SUBMITPLACE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/SUBMITPLACE))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
              <tr>
                <td class="f-lbl" style="border-bottom:0;">용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;도</td>
                <td style="border-right:0;border-bottom:0;" colspan="3">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="USECONTENT" class="txtText" maxlength="200" value="{//forminfo/maintable/USECONTENT}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/USECONTENT))" />
                    </xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
