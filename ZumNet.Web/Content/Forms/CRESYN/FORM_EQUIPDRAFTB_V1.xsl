                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0">자산번호</td>                      
                      <td class="f-lbl-sub" style="border-top:0">수량</td>
                      <td class="f-lbl-sub" style="border-top:0">구입년월</td>
                      <td class="f-lbl-sub" style="border-top:0">정비/점검내역</td>
    ...
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(EQUIPMENT))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(SERIALNUMBER))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(ASSETNUMBER))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(COMMENT))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
