        ...
        <table class="ft-sub-sub" header="0" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="subsub_table_row">
            ...
            <td style="border-right:0">
              ...
              <input type="hidden" name="SALESPLACEID">
                <xsl:attribute name="value">
                  <xsl:value-of select="SALESPLACEID" />
                </xsl:attribute>
              </input>
              <input type="hidden" name="SALESPLACESITEID">
                <xsl:attribute name="value">
                  <xsl:value-of select="SALESPLACESITEID" />
                </xsl:attribute>
              </input>
            </td>
          </tr>
          <tr class="subsub_table_row">
            ...
            <td>
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="SALESDATE" style="width:80px">
            ...
            <td style="border-right:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  ...
                  <input type="text" name="SALESCOST" style="width:192px">
                    <xsl:attribute name="class">txtDollar</xsl:attribute>
                    <xsl:attribute name="maxlength">20</xsl:attribute>
                    <xsl:attribute name="value">
                      <xsl:value-of select="SALESCOST" />
                    </xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
          ...
          <tr class="subsub_table_row">
            ...
            <td colspan="3" style="border-bottom:0;border-right:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <textarea name="SALESREASON" style="height:40px">
                    <xsl:attribute name="class">txaText</xsl:attribute>
                ...
                <xsl:otherwise>
                  <div name="SALESREASON" style="height:40px">
                    <xsl:attribute name="class">txaRead</xsl:attribute>
