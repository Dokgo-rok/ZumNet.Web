        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
                ...
                <td style="width:40%">
                  <xsl:choose>
                    <xsl:when test="$mode='new'">
                      <input type="text" id="__mainfield" name="APPLICANTCORP" style="width:50px">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new'">
                      <input type="text" id="__mainfield" name="APPLICANTDEPT" style="width:215px">
                        <xsl:attribute name="class">txtText</xsl:attribute>
                        <xsl:attribute name="readonly">readonly</xsl:attribute>
                        <xsl:attribute name="value">
                          <xsl:value-of select="//creatorinfo/department" />
              ...
              <tr>
                <td style="border-bottom:0;border-right:0;height:100px" colspan="5">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="PURPOSE" style="height:95px">
                    ...
                    <xsl:otherwise>
                      <div id="__mainfield" name="PURPOSE" style="">
