    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .fh h1 {font-size:16.0pt;letter-spacing:1pt}
        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" style="border-bottom:0">동의사항</td>
                <td colspan="4" style="border-bottom:0;border-right:0;height:100px">
                  1. 상기 본인은 연차휴가가 발생치 않았으나, 연차휴가를 선사용하고, 향후 발생되는 연차휴가에서 해당 휴가일을 공제하며, 선사용한 연차휴가가 퇴직 시점에 발생한 연차휴가를 초과했을 경우, 초과한 휴가일에 대한 임금을 급여에서 공제하는 것에 동의 합니다. 
                  <br />
                  2. 퇴직 시점의 급여가 초과 연차 사용 공제분보다 적을 경우, 해당 금액을 회사에 반납하는 것에 동의 합니다.
                </td>
              </tr>
            </table>
          </div>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td class="tdRead_Center">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <select name="VACCLASSDN" style="width:70px">
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(VACCLASSDN),'')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(VACCLASSDN),'연차')">
