      ...
      <head>
        ...
        <style type="text/css">
          <xsl:value-of select="phxsl:baseStyle()" />
			...
			/* 인쇄 설정 : 맨하단으로 */
			@media print {.m .fm-editor {height:600px; min-height:600px}}
		</style>
      </head>
      <body>
        <div class="m">
          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:320px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[@bizrole='agree' and @partid!='' and @step!='0'], '__si_Agree', '4', '합의부서')"/>
                </td>
              </tr>
            </table>
          </div>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="STEP" style="width:92%" value="PP" class="txtText_u" readonly="readonly" />                                           
                    </xsl:when>
                    <xsl:otherwise>
