        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl" colspan="3">당월 사장불용재고 발생금액 비율 (B)</td>
          ...
          <div class="fm">
            <span>4. 작업불량 및 사장불용재고 발생내역</span>
          </div>
            ...
            <table class="fc" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
              ...
              <tr>
                ...
                <td colspan="12" style="padding-top:5px">
                  <div id="panChart" style="position:relative;width:960px;height:150px;border:0px solid blue">
                    <!--//tw, th, tc, tsc, tdt, tls, tsw, lw, lc, ldt-->
