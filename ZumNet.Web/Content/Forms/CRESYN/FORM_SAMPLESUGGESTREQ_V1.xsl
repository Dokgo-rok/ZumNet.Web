    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          .m .ft .f-option {width:122px} .m .ft .f-option1 {width:50px}   .m .ft .f-option2 {width:70px}
        ...
        <div class="m">
          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="width:325">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='normal' and @partid!='' and @step!='0'], '__si_Normal', '4', '제안부서')"/>
                </td>
              ...
              <tr>
                ...
                <td style="border-right:0">
                  ...
                  <span class="f-option1">
                    <input type="checkbox" id="ckb23" name="ckbTYPECLASS" value="ETC">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbTYPECLASS', this, 'TYPECLASS')</xsl:attribute>
                      </xsl:if>
