        ...
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="COMPETENCY">
              <xsl:attribute name="class">txtText</xsl:attribute>              
              <xsl:attribute name="style">font-size:14px;height:40px</xsl:attribute>
              <xsl:attribute name="value">
        ...
        <xsl:choose>
          <xsl:when test="$actrole='_approver' and $bizrole='normal' and $partid !=''">
            <select name="CHANGE" style="font-size:20px;height:60px;width:90px;text-align:center">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'가')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(CHANGE),'부')">
