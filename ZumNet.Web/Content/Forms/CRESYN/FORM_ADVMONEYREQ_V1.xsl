		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					.m .fm1 span {font-size:13px;font-family:맑은 고딕}
					...
					{direction:rtl;ime-mode:active;width:200;padding-top:2px;padding-right:2;text-align:right;}
			...
			<body>
				<div class="m">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="f-lbl" style="border-bottom:0">신청 금액</td>
								<td style="border-right:0;border-bottom:0">
									<xsl:choose>
										<xsl:when test="$mode='read'">
											<xsl:value-of select="//forminfo/maintable/HOWMUCH" />원
										</xsl:when>
										<xsl:otherwise>
											<input type="text" name="HOWMUCH" id="__mainfield">
												<xsl:choose>
													...
													<xsl:when test="$mode='edit'">
														...
														<xsl:attribute name="maxlength">100</xsl:attribute>
														<xsl:attribute name="value">
															<xsl:value-of select="//forminfo/maintable/HOWMUCH" />
														</xsl:attribute>
													</xsl:when>													
												</xsl:choose>
											</input>원
