    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          /* 화면 넓이, 에디터 높이, 양식명크기 */
          .m {width:720px} .m .fm-editor {height:390px;border:windowtext 1pt solid}
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:300px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignRcvPart($root, //processinfo/signline/lines, 'distribution', '__si_Distribution', '4', '접수')"/>
                </td>
              </tr>
            </table>
          </div>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="PRODUCTCENTER" style="width:100%">
              <xsl:attribute name="class">txtText</xsl:attribute>
