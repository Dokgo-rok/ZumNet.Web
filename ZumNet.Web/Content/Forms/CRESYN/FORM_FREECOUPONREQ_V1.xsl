		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					/* 폰트 */
					.fh h1 {font-family:굴림체;font-weight:bold;font-size:20.0pt;letter-spacing:5pt;}
								...
								<td>
									<table id="__subtable1" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
										<tr style="height:25">
											...
											<td class="f-lbl-sub" style="width:;border-top:0">쿠 폰 종 류</td>
											<td class="f-lbl-sub" style="width:50px;border-top:0">수량</td>
											<td class="f-lbl-sub" style="width:100px;border-top:0;">단가</td>
											<td class="f-lbl-sub" style="width:120px;border-top:0;border-right:0">금액</td>
										</tr>
