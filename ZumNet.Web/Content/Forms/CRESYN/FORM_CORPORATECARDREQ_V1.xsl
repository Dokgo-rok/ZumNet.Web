				...
				<div class="m">
					...
					<div class="fm">
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
								...
								<td style="width:40%">
									<xsl:choose>
										<xsl:when test="$mode='new'">
											<input type="text" id="__mainfield" name="APPLICANTORG" style="width:100px">
										...
										<xsl:when test="$mode='edit'">
											<input type="text" id="__mainfield" name="APPLICANTORG" style="width:100px">
												...
												<xsl:attribute name="readonly">readonly</xsl:attribute>
												<xsl:attribute name="value">
													<xsl:value-of select="//forminfo/maintable/APPLICANTORG" />
												</xsl:attribute>
											</input>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/APPLICANTORG))" />
										</xsl:otherwise>
									</xsl:choose>.
									<xsl:choose>
										<xsl:when test="$mode='new'">
							...
							<tr>
								<td class="f-lbl">신청사유</td>
								<td colspan="4" style="border-right:0">
									<xsl:choose>
										<xsl:when test="$mode='new' or $mode='edit'">
											<textarea id="__mainfield" name="REASON" style="height:80px" class="txaText bootstrap-maxlength" maxlength="500">
						...
						<table class="ft" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td style="border:0;height:100px">
									<span style="width:100%;text-align:center">위 사유로 법인카드를 신청하오니 승인하여 주시기 바랍니다.</span>
								</td>
							</tr>
						</table>
					</div>
