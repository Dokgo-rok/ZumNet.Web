        ...
        <div class="m">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="f-lbl">휴가구분</td>
                <td colspan="4" style="border-right:0">
                  <span class="f-option">
                    <input type="checkbox" id="ckb11" name="ckbVACCLASS" value="공가">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVACCLASS', this, 'VACCLASS')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VACCLASS),'공가')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VACCLASS),'공가')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb11">공가</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb12" name="ckbVACCLASS" value="연차">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVACCLASS', this, 'VACCLASS')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VACCLASS),'연차')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VACCLASS),'연차')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb12">연차</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb13" name="ckbVACCLASS" value="생리">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVACCLASS', this, 'VACCLASS')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VACCLASS),'생리')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VACCLASS),'생리')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb13">생리</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb14" name="ckbVACCLASS" value="반차">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVACCLASS', this, 'VACCLASS')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VACCLASS),'반차')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VACCLASS),'반차')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb14">반차</label>
                  </span>
                  <span class="f-option">
                    <input type="checkbox" id="ckb15" name="ckbVACCLASS" value="1/4차">
                      <xsl:if test="$mode='new' or $mode='edit'">
                        <xsl:attribute name="onclick">parent.fnCheckYN('ckbVACCLASS', this, 'VACCLASS')</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="phxsl:isEqual(string(//forminfo/maintable/VACCLASS),'1/4차')">
                        <xsl:attribute name="checked">true</xsl:attribute>
                      </xsl:if>
                      <xsl:if test="$mode='read' and phxsl:isDiff(string(//forminfo/maintable/VACCLASS),'1/4차')">
                        <xsl:attribute name="disabled">disabled</xsl:attribute>
                      </xsl:if>
                    </input>
                    <label for="ckb15">1/4차</label>
                  </span>
                  <input type="hidden" id="__mainfield" name="VACCLASS">
                    <xsl:attribute name="value">
                      <xsl:value-of select="//forminfo/maintable/VACCLASS"></xsl:value-of>
                    </xsl:attribute>
                  </input>
                </td>
              </tr>
