                    ...
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        <select id="__mainfield" name="DOCCLASS" class="custom-select d-inline-block" style="width:100px;font-size:16pt;font-weight:bold">
                          ...
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DOCCLASS),'매각')">
                              <option value="매각" selected="selected">매각</option>
                            </xsl:when>
                            <xsl:otherwise>
                          ...
                          <xsl:choose>
                            <xsl:when test="phxsl:isEqual(string(//forminfo/maintable/DOCCLASS),'폐기')">
                              <option value="폐기" selected="selected">폐기</option>
                            </xsl:when>
                            <xsl:otherwise>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="width:320px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignPart($root, //processinfo/signline/lines/line[@bizrole='normal'  and @partid!='101362'  and @partid!=''  and @step!='0'], '__si_Normal', '4', '작성부서')"/>
                </td>
                  ...
                  <tr>
                    ...
                    <td class="fm-button">
                      ...
                      <!--<button onclick="parent.fnOption('iso.currency',160,140,10,115,'etc','CURRENCY');" onfocus="this.blur()" class="btn_bg" style="height:16px;">
						...
						<button type="button" class="btn btn-outline-secondary btn-18 mr-1" title="통화" onclick="_zw.formEx.optionWnd('iso.currency',220,274,-80,0,'etc','CURRENCY');">
                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="2"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">설비명</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">모델명</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">S/N</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">자산번호</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">수량</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">구입년월</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">사용기간</td>
                      <td class="f-lbl-sub" style="border-top:0" colspan="2">구입가</td>
                      <td class="f-lbl-sub" style="border-top:0" colspan="2">잔존가</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">판매금액</td>
                      <td class="f-lbl-sub" style="border-top:0" rowspan="2">매각처</td>
                      <td class="f-lbl-sub" style="border-top:0;border-right:0" rowspan="2">비고</td>
                    </tr>
                    <tr style="height:24px">
                      <td class="f-lbl-sub">단가</td>
                      <td class="f-lbl-sub">소계</td>
                      <td class="f-lbl-sub">단가</td>
                      <td class="f-lbl-sub">소계</td>
                    </tr>
                    <xsl:apply-templates select="//forminfo/subtables/subtable1/row"/>
                    <tr>
                      <td class="f-lbl-sub" colspan="8">TOTAL</td>
                      <td style="border-bottom:0;text-align:center">-</td>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="METHOD" style="height:40px" class="txaText bootstrap-maxlength" maxlength="500">
                        <xsl:if test="$mode='edit'">
    ...
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(ASSETNUMBER))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(PERIOD))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="SUM" class="txtCurrency" maxlength="20" data-inputmask="number;20;0" value="{SUM}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
