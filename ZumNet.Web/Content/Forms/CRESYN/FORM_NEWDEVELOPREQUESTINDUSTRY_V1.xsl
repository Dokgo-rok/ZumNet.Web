                  ...
                  <h1>
                    ...
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        &nbsp;(<select id="__mainfield" name="DEVMODELCLS" style="font-size:16pt;font-weight:bold">
                          <xsl:choose>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:308px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[(@bizrole='생산지' or @bizrole='agree' or @bizrole='confirm' or @bizrole='application' or @bizrole='manage') and @partid!='' and @step!='0'], '__si_Form', '4', '접수부서', '', 'BR')"/>
                </td>
                <td style="width:;font-size:1px">&nbsp;</td>
                <td style="width:92px">
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td colspan="2">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="SHIPDATE" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/SHIPDATE}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td colspan="2">
                  <!--<xsl:choose>
                    <xsl:when test="$bizrole='생산지' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="PRODUCTCENTER" style="width:85%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/PRODUCTCENTER}" />
                ...
                <td>
                  <!--<xsl:choose>
                    <xsl:when test="$bizrole='agree' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="GRADE" style="width:72%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/GRADE}" />
                  ...
                  <xsl:choose>
                    <xsl:when test="$bizrole='agree' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="GRADE" class="txtText" maxlength="50" value="{//forminfo/maintable/GRADE}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/GRADE))" />
                    </xsl:otherwise>
                ...
                <td style="border-right:0" colspan="2">
                  <!--<xsl:choose>
                    <xsl:when test="$bizrole='agree' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="SUPERVISION" class="txtRead" readonly="readonly" value="{//forminfo/maintable/SUPERVISION}" />
                  ...
                  <xsl:choose>
                    <xsl:when test="$bizrole='agree' and $actrole='_approver' and $partid!=''">
                      <input type="text" id="__mainfield" name="SUPERVISION" class="txtText" maxlength="50" value="{//forminfo/maintable/SUPERVISION}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/SUPERVISION))" />
                    </xsl:otherwise>
              ...
              <tr>
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY1" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/DAY1}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT1" class="txtNumberic" maxlength="100" value="{//forminfo/maintable/COUNT1}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY2" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/DAY2}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT2" class="txtNumberic" maxlength="100" value="{//forminfo/maintable/COUNT2}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY3" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/DAY3}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT3" class="txtNumberic" maxlength="100" value="{//forminfo/maintable/COUNT3}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY4" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/DAY4}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT4" class="txtNumberic" maxlength="100" value="{//forminfo/maintable/COUNT4}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DAY5" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid);" value="{//forminfo/maintable/DAY5}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="COUNT5" class="txtNumberic" maxlength="100" value="{/forminfo/maintable/COUNT5}" />
                    </xsl:when>
                    <xsl:otherwise>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL1" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL1}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL1))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL2" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL2}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL2))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL3" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL3}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL3))" />
                    </xsl:otherwise>
                ...
                <td style="border-right:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL4" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL4}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL4))" />
                    </xsl:otherwise>
              ...
              <tr>
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL5" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL5}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL5))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL6" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL6}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL6))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL7" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL7}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL7))" />
                    </xsl:otherwise>
                ...
                <td style="border-right:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL8" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL8}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL8))" />
                    </xsl:otherwise>
              ...
              <tr>
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL9" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL9}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL9))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL10" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL10}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL10))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL11" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL11}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL11))" />
                    </xsl:otherwise>
                ...
                <td style="border-right:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL12" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL12}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL12))" />
                    </xsl:otherwise>
              ...
              <tr>
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL13" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL13}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL13))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL14" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL14}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL14))" />
                    </xsl:otherwise>
                ...
                <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL15" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL15}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL15))" />
                    </xsl:otherwise>
                ...
                <td style="border-right:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL16" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL16}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL16))" />
                    </xsl:otherwise>
              ...
              <tr>
                <td style="border-bottom:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL17" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL17}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL17))" />
                    </xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL18" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL18}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL18))" />
                    </xsl:otherwise>
                ...
                <td style="border-bottom:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL19" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL19}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL19))" />
                    </xsl:otherwise>
                ...
                <td style="border-bottom:0;border-right:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="EXMODEL20" class="txtText" maxlength="100" value="{//forminfo/maintable/EXMODEL20}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(//forminfo/maintable/EXMODEL20))" />
                    </xsl:otherwise>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0" text-align="center">
              ...
              <tr>
                ...
                <td>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="DEVELOPPRICE" class="txtDollar" maxlength="20" value="{//forminfo/maintable/DEVELOPPRICE}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-right:0">
                  <!--<xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ESTIMATESTD" style="width:92%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/ESTIMATESTD}" />
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ESTIMATESTD" class="txtText" maxlength="100" value="{/forminfo/maintable/ESTIMATESTD}" />
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(//forminfo/maintable/ESTIMATESTD))" />
                    </xsl:otherwise>
              ...
              <tr>
                ...
                <td colspan="3" style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="PREDICTWAY" style="height:50px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 500);" >
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="CUSTOMERREQ" style="height:120px" class="txaText" onkeyup="parent.checkTextAreaLength(this, 500);" >
                        <xsl:value-of select="//forminfo/maintable/CUSTOMERREQ" />
                      </textarea>
                    </xsl:when>
                    <xsl:otherwise>
                      <div name="CUSTOMERREQ" style="height:120px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
  ...
  <xsl:template match="//forminfo/subtables/subtable1/row">
    <tr class="sub_table_row">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="ITEM" class="txtText" maxlength="30" value="{ITEM}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(ITEM))" />
          </xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="PREDICTPRICE" class="txtDollar" maxlength="20" value="{PREDICTPRICE}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="PREDICTPRICE2" class="txtDollar" maxlength="20" value="{PREDICTPRICE2}" />
          </xsl:when>
          <xsl:otherwise>
            <xsl:attribute name="class">tdRead_Right</xsl:attribute>
      ...
      <td  style="border-right:0">
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="ETC" class="txtText" maxlength="30" value="{ETC}" />
          </xsl:when>
          <xsl:otherwise>
