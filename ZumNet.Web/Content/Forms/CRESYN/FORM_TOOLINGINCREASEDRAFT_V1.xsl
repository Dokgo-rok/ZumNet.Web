      ...
      <body>
        <div class="m">
          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:7px;font-size:1px">&nbsp;</td>
                <td style="width:245px">
          ...
          <div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td class="f-lbl1" style="width:5%">Rev.</td>
                <td style="width:15%;border-right:0">
                  <xsl:choose>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:35%">
                  <!--<xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="ORGCODE">
                ...
                <td style="width:35%;border-right:0">
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="BUYER" style="width:92%" class="txtText_u" readonly="readonly" value="{//forminfo/maintable/BUYER}" />
          ...
          <div class="fm">
            <xsl:choose>
              <xsl:when test="$mode='read'">
                <span style="width:20%;border:0 solid red">1. 증작현황</span>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:35%">
                  ...
                  <input type="hidden" id="__mainfield" name="FMODELOID">
                    <xsl:attribute name="value">
                      <xsl:value-of select="//forminfo/maintable/FMODELOID" />
                    </xsl:attribute>
                  </input>
                  <input type="hidden" id="__mainfield" name="FMODELNM">
                    <xsl:attribute name="value">
                      <xsl:value-of select="//forminfo/maintable/FMODELNM" />
                    </xsl:attribute>
                  </input>
                </td>
                ...
                <td style="border-right:0">
                  ...
                  <input type="hidden" id="__mainfield" name="FSUPPLIERID">
                    <xsl:attribute name="value">
                      <xsl:value-of select="//forminfo/maintable/FSUPPLIERID" />
                    </xsl:attribute>
                  </input>
                  <input type="hidden" id="__mainfield" name="FSUPPLIERSITEID">
                    <xsl:attribute name="value">
                      <xsl:value-of select="//forminfo/maintable/FSUPPLIERSITEID" />
                    </xsl:attribute>
                  </input>
                </td>
              </tr>
              <tr>
                <td class="f-lbl">증작사유</td>
              ...
              <tr>
                ...
                <td class="f-lbl" style="border-bottom:0">금형제작기간</td>
                <td style="border-bottom:0;border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="FROMDATE" class="txtDate" style="width:70px" maxlength="8" value="{//forminfo/maintable/FROMDATE}">
                        <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                  ...
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <input type="text" id="__mainfield" name="TODATE" class="txtDate" style="width:70px" maxlength="8" value="{//forminfo/maintable/TODATE}">
                        <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                      </input>
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <xsl:when test="$mode='new' or $mode='edit'">
                  <tr>
                    ...
                    <td class="fm-button">
                      ...
                      &nbsp;&nbsp;적용환율 :
                      <input type="text" id="__mainfield" name="EXCHANGERATE" style="width:100px;border:0;border-bottom:1px solid windowtext" class="txtDate" maxlength="8" onclick="parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)" readonly="readonly" value="{//forminfo/maintable/EXCHANGERATE}" />
                      &nbsp;&nbsp;
              ...
              <tr>
                <td colspan="2">
                  <table id="__subtable2" class="ft-sub" header="1"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td class="f-lbl-sub" colspan="2" style="height:50px">TOTAL</td>
                      <td style="border-bottom:0">
                        <xsl:choose>
                          <xsl:when test="$mode='new' or $mode='edit'">
        ...
        <table class="ft-sub-sub" header="0" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="subsub_table_row">
            ...
            <td >
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <!--<input type="text" name="CLSNM" class="txtRead" readonly="readonly" value="{CLSNM}" />-->
              ...
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="MODELNM">
                    <xsl:attribute name="class">txtRead</xsl:attribute>
                    <xsl:attribute name="readonly">readonly</xsl:attribute>
                    <xsl:attribute name="value"><xsl:value-of select="MODELNM" /></xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
                ...
                <div>
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      ...
                      <input type="text" name="PARTNM1" style="width:315px">
                        <xsl:attribute name="class">txtText</xsl:attribute>                        
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM2" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM3" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM4" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM5" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM6" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM7" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM8" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM9" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
                  ...
                  <div>
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        ...
                        <input type="text" name="PARTNM10" style="width:315px">
                          <xsl:attribute name="class">txtRead</xsl:attribute>
                          <xsl:attribute name="readonly">readonly</xsl:attribute>
          ...
          <tr class="subsub_table_row">           
              ...
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <!--<input type="text" name="CMNTYPE">
                    <xsl:attribute name="class">txtRead</xsl:attribute>
                    <xsl:attribute name="readonly">readonly</xsl:attribute>
                    <xsl:attribute name="value"><xsl:value-of select="CMNTYPE" /></xsl:attribute>
                  </input>-->
            ...
            <td style="border-right:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="TOOLREQQTY">
          ...
          <tr class="subsub_table_row">
            ...
            <td>
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="CAVITYA" style="width:53px" class="txtNumberic" maxlength="3" value="{CAVITYA}" />
                  &nbsp;*&nbsp;
                  <input type="text" name="CAVITY" style="width:53px" class="txtNumberic" maxlength="3" value="{CAVITY}" />
                </xsl:when>
                <xsl:otherwise>
          ...
          <tr class="subsub_table_row">
            ...
            <td style="border-right:0">
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:isEmpty(string(ADDREASON))" />
                </xsl:otherwise>
              </xsl:choose>
            </td>
          </tr>
          <tr class="subsub_table_row">
            <td class="f-lbl-sub" style="">제작처</td>
            <td style="">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
            ...
            <td style="border-right:0">
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(RESULTSHOT))" />
                </xsl:otherwise>
              </xsl:choose>
            </td>
          </tr>
          ...
          <tr class="subsub_table_row">
            ...
            <td class="f-lbl-sub">이전제작비</td>
            <td style="border-right:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="PREPRODUCTCOSTCURRENCY" style="width:35px;height:16px">
                    <xsl:attribute name="class">txtText_u</xsl:attribute>
                    <xsl:attribute name="readonly">readonly</xsl:attribute>
                    <xsl:attribute name="value">
                      <xsl:value-of select="PREPRODUCTCOSTCURRENCY" />
                    </xsl:attribute>
                  </input>
                  <button onclick="parent.fnOption('iso.currency',160,140,10,115,'etc',this);" onfocus="this.blur()" class="btn_bg" style="height:16px;">
                    <img alt="" class="blt01" style="margin:0 0 2px 0">
                  ...
                  <input type="text" name="PREPRODUCTCOST" style="width:100px">
                    <xsl:attribute name="class">txtDollar</xsl:attribute>
                    <xsl:attribute name="maxlength">20</xsl:attribute>
                  </input>
                  <input type="text" name="CONVPREPRODUCTCOST" style="width:100px">
                    <xsl:attribute name="class">txtDollar</xsl:attribute>
                    <xsl:attribute name="readonly">readonly</xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
                  ...
                  &nbsp;=>&nbsp;<xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(CONVPREPRODUCTCOST))" />
                </xsl:otherwise>
              </xsl:choose>
            </td>
          </tr>
          ...
          <tr class="subsub_table_row">
            ...
            <td>
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='영업수신' and $actrole='__r' and $partid!='')">                  
                  <!--<input type="text" name="POSTYPE" class="txtRead" readonly="readonly" value="{POSTYPE}" />-->
            ...
            <td class="f-lbl-sub" style="">소유처</td>
            <td style="border-right:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit' or ($bizrole='영업수신' and $actrole='__r' and $partid!='')">
          ...
          <tr class="subsub_table_row">
            ...
            <td colspan="3" style="border-right:0">
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="MAKEFROM" class="txtDate" style="width:80px" maxlength="8" value="{MAKEFROM}">
                    <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when test="$mode='new' or $mode='edit'">
                  <input type="text" name="MAKETO" class="txtDate" style="width:80px" maxlength="8" value="{MAKETO}">
                    <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
          ...
          <tr class="subsub_table_row">
            ...
            <td style="border-right:0;border-bottom:0">
              <xsl:choose>
                <xsl:when test="$bizrole='영업수신' and $actrole='__r' and $partid!=''">
                  <input type="text" name="RTVLORGEXPDT" class="txtDate" style="width:80px" maxlength="8" value="{RTVLORGEXPDT}">
                    <xsl:attribute name="onclick">parent.fnShowPopSelfCalendar(this, parent.fnCalcValid)</xsl:attribute>
                  </input>
                </xsl:when>
                <xsl:otherwise>
