            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td style="border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                      <input type="text" id="__mainfield" name="MONTHCOUNT" class="txtText" maxlength="50" value="{//forminfo/maintable/MONTHCOUNT}" />
                    </xsl:when>
                    <xsl:otherwise>
                ...
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit' or $actrole='__r' or $actrole='_reviewer'">
                      <input type="text" id="__mainfield" name="YEARCOUNT" class="txtText" maxlength="50" value="{//forminfo/maintable/YEARCOUNT}" />
                    </xsl:when>
                    <xsl:otherwise>
