...
<xsl:stylesheet  version="1.0"
    ...
    <html>
      ...
      <body>
        <div class="m">
          ...
          <!--<div class="fm">
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-right:0;border-bottom:0;font-size:11.0pt">
                  <xsl:choose>
                    <xsl:when test="$bizrole='receive' and $actrole='_approver' and $partid !=''">
          ...
          <div class="fm">
            <table id="__si_Form"  class="ft" border="0" cellspacing="0" cellpadding="0" style="border-bottom:0">
              <xsl:apply-templates select="//processinfo/signline/lines/line[(@bizrole='receive' and @actrole='_approver') and @partid!='']">
              </xsl:apply-templates>
            </table>
          </div>
  ...
  <xsl:template match="//processinfo/signline/lines/line">
    <tr>      
      <td style="border-right:0;font-size:11.0pt">
