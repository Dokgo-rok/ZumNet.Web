            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td colspan="3" style="border-right:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="NOWWORK" style="height:60px">
                    ...
                    <xsl:otherwise>
                      <div id="__mainfield" name="NOWWORK" style="height:60px">
              ...
              <tr>
                ...
                <td colspan="3" style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="FUTUREWORK" style="height:60px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                        <xsl:attribute name="onkeyup">parent.checkTextAreaLength(this, 500)</xsl:attribute>
                        <xsl:if test="$mode='edit'">
                    ...
                    <xsl:otherwise>
                      <div id="__mainfield" name="FUTUREWORK" style="height:60px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
            ...
            <table class="ft" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border-right:0;border-bottom:0">
                  <xsl:choose>
                    <xsl:when test="$mode='new' or $mode='edit'">
                      <textarea id="__mainfield" name="DESCRIPTION" style="height:220px">
                        <xsl:attribute name="class">txaText</xsl:attribute>
                    ...
                    <xsl:otherwise>
                      <div id="__mainfield" name="DESCRIPTION" style="height:220px">
                        <xsl:attribute name="class">txaRead</xsl:attribute>
