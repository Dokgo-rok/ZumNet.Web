          ...
          <div class="fb">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td style="width:250px">
                  <xsl:value-of disable-output-escaping="yes" select="phxsl:mappingSignSerialPart($root, //processinfo/signline/lines/line[@bizrole='confirm' and @partid!='' and @step!='0'], '__si_Confirm', '3', '접수부서')"/>
                </td>
              </tr>
            </table>
          </div>
                ...
                <td colspan="2">
                  <table id="__subtable1" class="ft-sub" header="1" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr style="height:24px">
                      ...
                      <td class="f-lbl-sub" style="border-top:0;" colspan="2">구분</td>                      
                      <td class="f-lbl-sub" style="border-top:0;border-right:0">본사PO/NO</td>
                    </tr>
          ...
          <div class="fm-editor">
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <iframe id="ifrWebEditor" frameborder="0" width="100%" height="360px" marginheight="0" marginwidth="0" scrolling="no">
                  <xsl:attribute name="src">
    ...
    <tr class="sub_table_row">
      <td>
        <xsl:choose>
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="ROWSEQ" class="txtRead" readonly="readonly" value="{ROWSEQ}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="MODELNAME" class="txtRead" readonly="readonly" value="{MODELNAME}" />
          </xsl:when>
          <xsl:otherwise>            
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="ITEMNO" class="txtRead" readonly="readonly" value="{ITEMNO}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="ITEMNAME" class="txtText" maxlength="100" value="{ITEMNAME}" />              
          </xsl:when>
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="STANDARD" class="txtText" maxlength="100" value="{STANDARD}" />
          </xsl:when>
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="STANDARD" class="txtRead" readonly="readonly" value="{STANDARD}" />
          </xsl:when>
          <xsl:otherwise>            
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="COUNT" class="txtNumberic" maxlength="10" value="{COUNT}" />              
          </xsl:when>
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="WISHDATE" class="txtRead" readonly="readonly" value="{WISHDATE}" />
          </xsl:when>
          <xsl:otherwise>            
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="FROMPLACE" class="txtText" maxlength="100" value="{FROMPLACE}" />              
          </xsl:when>
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="FROMPLACE" class="txtRead" readonly="readonly" value="{FROMPLACE}" />
          </xsl:when>
          <xsl:otherwise>            
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(FROMPLACE))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <input type="text" name="TOPLACE" class="txtText" maxlength="100" value="{TOPLACE}" />
          </xsl:when>
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="TOPLACE" class="txtRead" readonly="readonly" value="{TOPLACE}" />
          </xsl:when>
          <xsl:otherwise>            
            <xsl:value-of disable-output-escaping="yes" select="phxsl:encodeHtml(string(TOPLACE))" />
          </xsl:otherwise>
        </xsl:choose>
      </td>
      <td>
        <xsl:choose>
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="USAGE" class="txtRead" readonly="readonly" value="{USAGE}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="$mode='new' or $mode='edit'">
            <select name="ITEMTYPE" style="">
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(ITEMTYPE),'')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(ITEMTYPE),'신규')">
              ...
              <xsl:choose>
                <xsl:when test="phxsl:isEqual(string(ITEMTYPE),'공용')">
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="ITEMTYPE" class="txtRead" readonly="readonly" value="{ITEMTYPE}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td>
        <xsl:choose>
          ...
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="MONEYTYPE" class="txtRead" readonly="readonly" value="{MONEYTYPE}" />
          </xsl:when>
          <xsl:otherwise>
      ...
      <td style="border-right:0">
        <xsl:choose>
          <xsl:when test="$bizrole='receive' and $actrole='__r'">
            <input type="text" name="PONO" class="txtText" maxlength="100" value="{PONO}" />
          </xsl:when>
          <xsl:otherwise>
