              ...
              <tr>
                <td colspan="6">
                  <font size="2">
                    ...
                    원으로 한다.<br />
                    제  3 조 (연봉의 지급방법)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    연봉은 월급여와 자동화설계수당으로 구분하여 지급한다.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    월급여는 
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                    ...
                    </xsl:choose> 원 으로 구성된다.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    자동화설계수당은 분기당 1회
                    <xsl:choose>
                      <xsl:when test="$mode='new' or $mode='edit'">
                        <input type="text" id="__mainfield" name="OTHERMONEY" class="txtRead" readonly="readonly" maxlength="100" style="width:40px" value="{//forminfo/maintable/OTHERMONEY}" />
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:value-of disable-output-escaping="yes" select="phxsl:addComma(string(//forminfo/maintable/OTHERMONEY))" />
                      </xsl:otherwise>
                    </xsl:choose> 원을 매분기 마지막 월의 급여일에 지급한다.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    자동화설계수당은 지급일前 퇴사시에는 지급하지 않으며, 세부 운영은 자동화촉진지원금 규정을 따른다.<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
